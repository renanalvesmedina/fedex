...
public class FUPReportRunnerCCT extends ExcelRemoteReportRunnerCCT {

	public FUPReportRunnerCCT(byte[] byteArrayTemplate, String fileName, File reportOutputDir) {
