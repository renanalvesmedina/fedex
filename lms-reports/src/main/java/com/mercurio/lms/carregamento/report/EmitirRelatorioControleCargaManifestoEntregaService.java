...
public class EmitirRelatorioControleCargaManifestoEntregaService extends RelatorioControleCargaColetaEntregaService {
	...
	public JRDataSource executeMountCabecalho(Long idControleCarga, Long idManifesto) throws Exception {
		...
		tfm.put("tpManifesto", ConstantesExpedicao.TP_RELATORIO_CONTROLE_CARGA_ENTREGA);
	...
	public JRDataSource executeMountDocumentosEntrega(Long idControleCarga, Long idManifesto) throws Exception {
		return super.executeMountDocumentosEntrega(idControleCarga, idManifesto);
	}
