 ...
 *
 * @spring.bean id="lms.vendas.clienteTabelaDesatualizadaAnaliticoService"
 * @spring.property name="reportName" value="com/mercurio/lms/vendas/report/clientesTabelasAntigasAnalitico.jasper"
 */
public class ClienteTabelaDesatualizadaAnaliticoService extends ReportServiceSupport {
	...
	private SqlTemplate getSqlTemplate(TypedFlatMap parameters) throws Exception {
		...
		sql.addProjection("stp.id_subtipo_tabela_preco", "id_subtipo_tabela_preco");
		...
		if(idPromotor != null) {
			...
			String dsPromotor = parameters.getString("usuario.nmUsuario");
