...
public class TabelaFreteAereoEspecificaKiloExcedenteService extends ReportServiceSupport {
	...
	public List<Map<String, String>> findDados(TypedFlatMap parameters) throws Exception {
		...
		List<Map<String, String>> listaDadosCompleta = executeBuscaDados(hasProdutoEspecifico(parameters), (Map) parametros.get("idsPametrosClientePorGrupo"), parameters.getString("ordenacao"));
	...
	private Boolean hasProdutoEspecifico(TypedFlatMap parameters) {
		Boolean retorno = Boolean.FALSE;
		Simulacao simulacao = ((Simulacao) parameters.get("simulacao"));

		if (simulacao != null && simulacao.getProdutoEspecifico() != null) {
	...
	@SuppressWarnings({ "unchecked", "rawtypes" })
	private List<Map<String, String>> executeBuscaDados(Boolean hasProdutoEspecifico, Map idsPametrosClientePorGrupoMap, String orderBy) {
	...
	private String getQueryProdutoEspecifico(int indexGrupo, String idsParametroClienteIn, String orderBy){
		...
		sql.append(", to_char(pc.vl_minimo_frete_quilo, 'FM999G999G990D90') vlTarifaMinima ");
		sql.append(", to_char(pc.vl_tbl_especifica, 'FM999G999G990D90')  vlProdutoEspecifico ");
	...
	private String getQueryListaPreco(int indexGrupo, String idsParametroClienteIn, String orderBy){
		...
		sql.append("     , dest.sg_aeroporto || ' - ' || mun.nm_municipio || ' - ' || unf.sg_unidade_federativa   dsDestino ");
		sql.append("     , to_char(pc.vl_minimo_frete_quilo, 'FM999G999G990D90') vlTarifaMinima ");
		sql.append("     , to_char(pc.vl_frete_peso, 'FM999G999G990D90') vlKilo ");
		sql.append("     , to_char(pc.vl_min_frete_peso, 'FM999G999G990D90') pesoMinimo ");
