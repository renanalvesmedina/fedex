 ...
 *
 * @spring.bean id="lms.vendas.tabelaFreteInternacionalTarifaService"
 * @spring.property name="reportName" value="com/mercurio/lms/vendas/report/emitirTabelaFreteInternacionalTarifa.jasper"
 */
public class TabelaFreteInternacionalTarifaService extends ReportServiceSupport {
