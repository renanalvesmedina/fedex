...
/**
 * @spring.bean id="lms.vendas.emitirClientesPerdidosService"
 * @spring.property name="reportName" value="com/mercurio/lms/vendas/report/emitirRelacaoClientesPerdidos.jasper"
 */											
public class EmitirClientesPerdidosService extends ReportServiceSupport {
