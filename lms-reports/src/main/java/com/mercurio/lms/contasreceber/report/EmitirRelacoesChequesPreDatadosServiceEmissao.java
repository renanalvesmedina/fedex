 ...
 *  
 * Relatorio de cheques por data de emissao
 * @author Rafael Andrade de Oliveira
 * @since 24/03/2006
 * 
 * Não inserir documentação após ou remover a tag do XDoclet a seguir.
 * O valor do <code>id</code> informado abaixo deve ser utilizado para referenciar este serviço.
 * @spring.bean id="lms.contasreceber.emitirRelacoesChequesPreDatadosServiceEmissao"
 * @spring.property name="reportName" value="com/mercurio/lms/contasreceber/report/emitirRelacoesChequesPreDatadosEmissao.jasper"
 */

public class EmitirRelacoesChequesPreDatadosServiceEmissao extends ReportServiceSupport {
	...
	private SqlTemplate getSql(Map parameters) {
		...
		/* Ordenação */
		sql.addOrderBy("lc.dt_emissao, f.sg_filial, c.nr_banco, c.nr_agencia, c.nr_conta_corrente, c.nr_cheque");
