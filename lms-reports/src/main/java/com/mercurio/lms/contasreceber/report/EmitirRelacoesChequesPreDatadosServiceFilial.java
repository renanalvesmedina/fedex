 ...
 *  
 * Emissao de relatorio de cheques por filial
 * @author Rafael Andrade de Oliveira
 * @since 24/03/2006
 * 
 * Não inserir documentação após ou remover a tag do XDoclet a seguir.
 * O valor do <code>id</code> informado abaixo deve ser utilizado para referenciar este serviço.
 * @spring.bean id="lms.contasreceber.emitirRelacoesChequesPreDatadosServiceFilial"
 * @spring.property name="reportName" value="com/mercurio/lms/contasreceber/report/emitirRelacoesChequesPreDatadosFilial.jasper"
 */

public class EmitirRelacoesChequesPreDatadosServiceFilial extends ReportServiceSupport {
	...
	private SqlTemplate getSql(Map parameters) {
		...
		sql.addCriteria("hc.id_usuario", "=", tfm.getLong("usuario.idUsuario"));
		...
		/* Ordenação */
		sql.addOrderBy("f.sg_filial, c.dt_vencimento, c.nr_banco, c.nr_agencia, c.nr_conta_corrente, c.nr_cheque");
