 ...
 * 
 * @spring.bean id="lms.indenizacoes.emitirTempoMedioIndenizacaoDetalhadoService"
 * @spring.property name="reportName" value="com/mercurio/lms/indenizacoes/report/emitirRelatorioTempoMedioIndenizacaoPai.jasper"
 */
public class EmitirTempoMedioIndenizacaoDetalhadoService extends EmitirTempoMedioIndenizacao {
    ...
    public JRDataSource executeFiliaisDebitadas(Long idRim) {
        SqlTemplate sql = createSqlTemplate();
