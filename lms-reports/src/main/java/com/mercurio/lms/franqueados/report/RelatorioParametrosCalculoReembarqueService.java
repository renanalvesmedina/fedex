...
/**
 * @spring.bean id="lms.vendas.emitirRelatorioParametrosCalculoReembarqueService"
 * @spring.property name="reportName" value="com/mercurio/lms/franqueados/report/emitirRelatorioParametrosCalculoReembarque.jasper"
 */
public class RelatorioParametrosCalculoReembarqueService extends ReportServiceSupport {
	...
	protected String getQueryDefault(Map parameters){
		String query = "SELECT PC_TONELADA, "
				+"        VL_CTE, "
				+"       DT_VIGENCIA_INICIAL, "
				+"        DT_VIGENCIA_FINAL "
				+" FROM   REEMBARQUE_FRQ "
