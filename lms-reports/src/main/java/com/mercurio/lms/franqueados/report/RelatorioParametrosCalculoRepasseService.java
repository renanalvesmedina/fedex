...
/**
 * @spring.bean id="lms.vendas.emitirRelatorioParametrosCalculoRepasseService"
 * @spring.property name="reportName" value="com/mercurio/lms/franqueados/report/emitirRelatorioParametrosCalculoRepasse.jasper"
 */
public class RelatorioParametrosCalculoRepasseService extends ReportServiceSupport {
	...
	protected String getQueryDefault(Map parameters){
		String query = "SELECT PC_ALIQ_PIS, "
		+"       PC_REPASSE_PIS, "
		+"       PC_ALIQ_COFINS, "
		+"       PC_REPASSE_COFINS, "
		+"       PC_REPASSE_ICMS, "
