...
/**
 * @spring.bean id="lms.vendas.emitirRelatorioParametrosCalculoDistanciaColetaEntregaService"
 * @spring.property name="reportName" value="com/mercurio/lms/franqueados/report/emitirRelatorioParametrosCalculoDistanciaColetaEntrega.jasper"
 */
public class RelatorioParametrosCalculoDistanciaColetaEntregaService extends ReportServiceSupport {
	...
	public String getTipoPavimento(String siglaPavimento){
		if (StringUtils.isBlank(siglaPavimento)) {
			return null;
		}
		return getDomainValueService().findDomainValueByValue("DM_TIPO_PAVIMENTO", siglaPavimento).getDescription().getValue();
	}
