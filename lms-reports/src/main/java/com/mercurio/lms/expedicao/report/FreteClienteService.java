 ...
 *
 * @spring.bean id="lms.expedicao.freteClienteService"
 * @spring.property name="reportName" value="com/mercurio/lms/expedicao/report/relatorioFretesCliente.jasper"
 */
public class FreteClienteService extends ReportServiceSupport {
