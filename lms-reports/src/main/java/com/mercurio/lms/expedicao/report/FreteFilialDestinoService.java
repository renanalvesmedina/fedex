 ...
 *
 * @spring.bean id="lms.expedicao.freteFilialDestinoService"
 * @spring.property name="reportName" value="com/mercurio/lms/expedicao/report/relatorioFretesFilialDestino.jasper"
 */
public class FreteFilialDestinoService extends ReportServiceSupport {
