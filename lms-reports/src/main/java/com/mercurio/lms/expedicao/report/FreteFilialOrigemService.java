 ...
 *
 * @spring.bean id="lms.expedicao.freteFilialOrigemService"
 * @spring.property name="reportName" value="com/mercurio/lms/expedicao/report/relatorioFretesFilialOrigem.jasper"
 */
public class FreteFilialOrigemService extends ReportServiceSupport {
