...
public class EmitirPreFaturaServicoSinteticoService extends ReportServiceSupport {
	...
	public JRReportDataObject execute(Map parameters) throws Exception {
		...
		final List<Map<String, Object>> itens = preFaturaServicoItemService.findReportEmissaoPreFatura(idPreFatura);
