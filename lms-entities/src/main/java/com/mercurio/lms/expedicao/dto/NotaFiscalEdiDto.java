...
public class NotaFiscalEdiDto implements Serializable {
    ...
    public NotaFiscalEdiDto() {
    }

    public NotaFiscalEdiDto(Long idNotaFiscalEdi, Integer nrNotaFiscal, Long cnpjDestinatario, String razaoSocial) {
    ...
    public NotaFiscalEdiDto(NotaFiscalEdi notaFiscalEdi) {
        this.idNotaFiscalEdi = notaFiscalEdi.getIdNotaFiscalEdi();
        this.nrNotaFiscal = notaFiscalEdi.getNrNotaFiscal();
        this.cnpjDestinatario = notaFiscalEdi.getCnpjDestinatario();
        this.razaoSocial = notaFiscalEdi.getRazaoSocial();
        this.nomeReme = notaFiscalEdi.getNomeReme();
        this.cnpjReme = notaFiscalEdi.getCnpjReme();
        this.ieReme = notaFiscalEdi.getIeReme();
        this.enderecoReme = notaFiscalEdi.getEnderecoReme();
        this.bairroReme = notaFiscalEdi.getBairroReme();
        this.municipioReme = notaFiscalEdi.getMunicipioReme();
        this.ufReme = notaFiscalEdi.getUfReme();
        this.cepEnderReme = notaFiscalEdi.getCepEnderReme();
        this.cepMuniReme = notaFiscalEdi.getCepMuniReme();
        this.nomeDest = notaFiscalEdi.getNomeDest();
        this.cnpjDest = notaFiscalEdi.getCnpjDest();
        this.ieDest = notaFiscalEdi.getIeDest();
        this.enderecoDest = notaFiscalEdi.getEnderecoDest();
        this.bairroDest = notaFiscalEdi.getBairroDest();
        this.municipioDest = notaFiscalEdi.getMunicipioDest();
        this.ufDest = notaFiscalEdi.getUfDest();
        this.cepEnderDest = notaFiscalEdi.getCepEnderDest();
        this.cepMunicDest = notaFiscalEdi.getCepMunicDest();
        this.nomeConsig = notaFiscalEdi.getNomeConsig();
        this.cnpjConsig = notaFiscalEdi.getCnpjConsig();
        this.ieConsig = notaFiscalEdi.getIeConsig();
        this.enderecoConsig = notaFiscalEdi.getEnderecoConsig();
        this.bairroConsig = notaFiscalEdi.getBairroConsig();
        this.municipioConsig = notaFiscalEdi.getMunicipioConsig();
        this.ufConsig = notaFiscalEdi.getUfConsig();
        this.cepEnderConsig = notaFiscalEdi.getCepEnderConsig();
        this.cepMunicConsig = notaFiscalEdi.getCepMunicConsig();
        this.nomeRedesp = notaFiscalEdi.getNomeRedesp();
        this.cnpjRedesp = notaFiscalEdi.getCnpjRedesp();
        this.ieRedesp = notaFiscalEdi.getIeRedesp();
        this.enderecoRedesp = notaFiscalEdi.getEnderecoRedesp();
        this.bairroRedesp = notaFiscalEdi.getBairroRedesp();
        this.municipioRedesp = notaFiscalEdi.getMunicipioRedesp();
        this.ufRedesp = notaFiscalEdi.getUfRedesp();
        this.cepEnderRedesp = notaFiscalEdi.getCepEnderRedesp();
        this.cepMunicRedesp = notaFiscalEdi.getCepMunicRedesp();
        this.nomeTomador = notaFiscalEdi.getNomeTomador();
        this.cnpjTomador = notaFiscalEdi.getCnpjTomador();
        this.ieTomador = notaFiscalEdi.getIeTomador();
        this.enderecoTomador = notaFiscalEdi.getEnderecoTomador();
        this.bairroTomador = notaFiscalEdi.getBairroTomador();
        this.municipioTomador = notaFiscalEdi.getMunicipioTomador();
        this.ufTomador = notaFiscalEdi.getUfTomador();
        this.cepEnderTomador = notaFiscalEdi.getCepEnderTomador();
        this.cepMunicTomador = notaFiscalEdi.getCepMunicTomador();
        this.natureza = notaFiscalEdi.getNatureza();
        this.especie = notaFiscalEdi.getEspecie();
        this.tipoFrete = notaFiscalEdi.getTipoFrete();
        this.modalFrete = notaFiscalEdi.getModalFrete();
        this.tipoTabela = notaFiscalEdi.getTipoTabela();
        this.tarifa = notaFiscalEdi.getTarifa();
        this.serieNf = notaFiscalEdi.getSerieNf();
        this.dataEmissaoNf = notaFiscalEdi.getDataEmissaoNf();
        this.dataLog = notaFiscalEdi.getDataLog();
        this.qtdeVolumes = notaFiscalEdi.getQtdeVolumes();
        this.vlrTotalMerc = notaFiscalEdi.getVlrTotalMerc();
        this.pesoReal = notaFiscalEdi.getPesoReal();
        this.pesoCubado = notaFiscalEdi.getPesoCubado();
        this.chaveNfe = notaFiscalEdi.getChaveNfe();
        this.vlrIcmsNf = notaFiscalEdi.getVlrIcmsNf();
        this.vlrIcmsStNf = notaFiscalEdi.getVlrIcmsStNf();
        this.aliqNf = notaFiscalEdi.getAliqNf();
        this.vlrBaseCalcNf = notaFiscalEdi.getVlrBaseCalcNf();
        this.vlrBaseCalcStNf = notaFiscalEdi.getVlrBaseCalcStNf();
        this.vlrTotProdutosNf = notaFiscalEdi.getVlrTotProdutosNf();
        this.cfopNf = notaFiscalEdi.getCfopNf();
        this.pinSuframa = notaFiscalEdi.getPinSuframa();
        this.sequenciaAgrupamento = notaFiscalEdi.getSequenciaAgrupamento();
        this.vlrFretePeso = notaFiscalEdi.getVlrFretePeso();
        this.vlrFreteValor = notaFiscalEdi.getVlrFreteValor();
        this.vlrCat = notaFiscalEdi.getVlrCat();
        this.vlrDespacho = notaFiscalEdi.getVlrDespacho();
        this.vlrItr = notaFiscalEdi.getVlrItr();
        this.vlrAdeme = notaFiscalEdi.getVlrAdeme();
        this.vlrPedagio = notaFiscalEdi.getVlrPedagio();
        this.vlrTaxas = notaFiscalEdi.getVlrTaxas();
        this.outrosValores = notaFiscalEdi.getOutrosValores();
        this.vlrIcms = notaFiscalEdi.getVlrIcms();
        this.vlrBaseCalcIcms = notaFiscalEdi.getVlrBaseCalcIcms();
        this.aliqIcms = notaFiscalEdi.getAliqIcms();
        this.vlrFreteLiquido = notaFiscalEdi.getVlrFreteLiquido();
        this.vlrFreteTotal = notaFiscalEdi.getVlrFreteTotal();
        this.pesoRealTotal = notaFiscalEdi.getPesoRealTotal();
        this.pesoCubadoTotal = notaFiscalEdi.getPesoCubadoTotal();
        this.vlrTotalMercTotal = notaFiscalEdi.getVlrTotalMercTotal();
        this.dsDivisaoCliente = notaFiscalEdi.getDsDivisaoCliente();
        this.nrCtrcSubcontratante = notaFiscalEdi.getNrCtrcSubcontratante();
        this.qtVolumeInformado = notaFiscalEdi.getQtVolumeInformado();
        this.blPaletizacao = notaFiscalEdi.getBlPaletizacao();
        this.nrEtiquetaInicial = notaFiscalEdi.getNrEtiquetaInicial();
        this.nrEtiquetaFinal = notaFiscalEdi.getNrEtiquetaFinal();
    }
