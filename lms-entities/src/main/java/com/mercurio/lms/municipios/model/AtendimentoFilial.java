...
public class AtendimentoFilial implements Serializable,Vigencia {
    ...
    /** persistent field */
    private DomainValue tpAtendimento;

    /** persistent field */
    private String obAtendimento;
    ...
    public Long getIdAtendimentoFilial() {
        return this.idAtendimentoFilial;
    }
    ...
    public DomainValue getTpAtendimento() {
        return this.tpAtendimento;
    }

    public void setTpAtendimento(DomainValue tpAtendimento) {
    ...
    public String toString() {
		return new ToStringBuilder(this).append("idAtendimentoFilial",
				getIdAtendimentoFilial()).toString();
    }

    public boolean equals(Object other) {
		if ((this == other))
			return true;
		if (!(other instanceof AtendimentoFilial))
			return false;
        AtendimentoFilial castOther = (AtendimentoFilial) other;
		return new EqualsBuilder().append(this.getIdAtendimentoFilial(),
				castOther.getIdAtendimentoFilial()).isEquals();
    }

    public int hashCode() {
		return new HashCodeBuilder().append(getIdAtendimentoFilial())
            .toHashCode();
    }

	public String getObAtendimento() {
		return obAtendimento;
	}

	public void setObAtendimento(String obAtendimento) {
		this.obAtendimento = obAtendimento;
	}
