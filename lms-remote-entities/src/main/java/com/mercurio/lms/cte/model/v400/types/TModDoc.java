...
public enum TModDoc {
     ...
     * Field enumConstants.
     */
    private static final java.util.Map<String, TModDoc> enumConstants = new java.util.HashMap<String, TModDoc>();
    ...
    private TModDoc(final String value) {
        this.value = value;
    }
     ...
     */
    public static TModDoc fromValue(
            final String value) {
