...
/**
 * Informações de quantidades da Carga do CT-ePara o modal aéreo
 * é obrigatório o preenchimento desse campo pelo menos 3 vezes.
 *  1 - Peso Bruto, sempre em quilogramas;
 *  2 - Peso Cubado; sempre em quilogramas;
 *  3 - Quantidade de volumes, sempre em unidades.
 * 
...
public class InfQ implements java.io.Serializable {
     ...
     */
    private com.mercurio.lms.cte.model.v104.types.CUnidType _cUnid;
     ...
     */
    public com.mercurio.lms.cte.model.v104.types.CUnidType getCUnid(
    ) {
        return this._cUnid;
    }
    ...
    public void setCUnid(
            final com.mercurio.lms.cte.model.v104.types.CUnidType cUnid) {
        this._cUnid = cUnid;
    }
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled com.mercurio.lms.cte.model.InfQ
     */
    public static com.mercurio.lms.cte.model.v104.InfQ unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.mercurio.lms.cte.model.v104.InfQ) org.exolab.castor.xml.Unmarshaller.unmarshal(com.mercurio.lms.cte.model.v104.InfQ.class, reader);
    }
