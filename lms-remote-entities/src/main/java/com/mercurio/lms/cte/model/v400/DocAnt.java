...
public class DocAnt implements java.io.Serializable {
     ...
     */
    private java.util.Vector<EmiDocAnt> _emiDocAntList;
    ...
    public DocAnt() {
        super();
        this._emiDocAntList = new java.util.Vector<EmiDocAnt>();
    }
     ...
     * com.mercurio.lms.cte.model.v400.EmiDocAnt elements
     */
    public java.util.Enumeration<? extends EmiDocAnt> enumerateEmiDocAnt(
    ) {
     ...
     * com.mercurio.lms.cte.model.v400.EmiDocAnt at the given index
     */
    ...
    throws IndexOutOfBoundsException {
        ...
        return (EmiDocAnt) _emiDocAntList.get(index);
    }
    ...
    public EmiDocAnt[] getEmiDocAnt(
        ...
        EmiDocAnt[] array = new EmiDocAnt[0];
        return (EmiDocAnt[]) this._emiDocAntList.toArray(array);
    }
     ...
     */
    public EmiDocAnt removeEmiDocAntAt(
            final int index) {
        Object obj = this._emiDocAntList.remove(index);
        return (EmiDocAnt) obj;
    }
     ...
     */
    public void setEmiDocAnt(
            final EmiDocAnt[] vEmiDocAntArray) {
        //-- copy array
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled com.mercurio.lms.cte.model.v400.DocAn
     */
    public static DocAnt unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (DocAnt) org.exolab.castor.xml.Unmarshaller.unmarshal(DocAnt.class, reader);
    }
