...
public enum TpCarType {
     ...
     * Field enumConstants.
     */
    private static final java.util.Map<String, TpCarType> enumConstants = new java.util.HashMap<String, TpCarType>();
    ...
    private TpCarType(final String value) {
        this.value = value;
    }
     ...
     */
    public static TpCarType fromValue(
            final String value) {
