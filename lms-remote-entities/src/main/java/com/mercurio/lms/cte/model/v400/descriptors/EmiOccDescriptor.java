...
import com.mercurio.lms.cte.model.v400.EmiOcc;
...
public class EmiOccDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public EmiOccDescriptor() {
        ...
        //-- _cInt
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(String.class, "_cInt", "cInt", org.exolab.castor.xml.NodeType.Element);
        desc.setImmutable(true);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public Object getValue( Object object )
