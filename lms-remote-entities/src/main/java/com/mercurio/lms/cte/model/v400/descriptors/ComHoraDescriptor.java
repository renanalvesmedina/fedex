...
import com.mercurio.lms.cte.model.v400.ComHora;
...
public class ComHoraDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ComHoraDescriptor() {
        ...
        //-- _hProg
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(String.class, "_hProg", "hProg", org.exolab.castor.xml.NodeType.Element);
        desc.setImmutable(true);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public Object getValue( Object object )
