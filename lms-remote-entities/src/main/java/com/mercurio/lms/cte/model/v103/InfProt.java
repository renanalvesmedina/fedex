...
public class InfProt implements java.io.Serializable {
     ...
     * 2 - Homologação
     */
    private com.mercurio.lms.cte.model.v103.types.TpAmbType _tpAmb;
    ...
    /**
     * Chaves de acesso da NF-e, compostas por: UF do emitente,
     * AAMM da emissão do CTe, CNPJ do emitente, modelo, série e
     * número do CT-e e código numérico+DV.
     */
    ...
    /**
     * Número do Protocolo de Status da CT-e. 1 posição (1 –
    ...
    /**
     * Digest Value do CT-e processada. Utilizado para conferir a
     * integridade da CT-e original.
     */
     ...
     * the following description: Chaves de acesso da NF-e,
     * compostas por: UF do emitente, AAMM da emissão do CTe, CNPJ
     * do emitente, modelo, série e número do CT-e e código
     * numérico+DV.
     * 
     ...
     * the following description: Digest Value do CT-e processada.
     * Utilizado para conferir a integridade da CT-e original.
     * 
     ...
     * the following description: Número do Protocolo de Status da
     * CT-e. 1 posição (1 – Secretaria de Fazenda Estadual 2
     * – Receita Federal); 2 - códiga da UF - 2 posições ano;
     ...
     */
    public com.mercurio.lms.cte.model.v103.types.TpAmbType getTpAmb(
    ) {
        return this._tpAmb;
    }
     ...
     * following description: Chaves de acesso da NF-e, compostas
     * por: UF do emitente, AAMM da emissão do CTe, CNPJ do
     * emitente, modelo, série e número do CT-e e código
     * numérico+DV.
     * 
     ...
     * following description: Digest Value do CT-e processada.
     * Utilizado para conferir a integridade da CT-e original.
     * 
     ...
     * following description: Número do Protocolo de Status da
     * CT-e. 1 posição (1 – Secretaria de Fazenda Estadual 2
     * – Receita Federal); 2 - códiga da UF - 2 posições ano;
     * 10 seqüencial no ano.
     * 
    ...
    public void setTpAmb(
            final com.mercurio.lms.cte.model.v103.types.TpAmbType tpAmb) {
        this._tpAmb = tpAmb;
    }
     ...
     * com.mercurio.lms.cte.model.v103.InfProt
     */
    public static com.mercurio.lms.cte.model.v103.InfProt unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.mercurio.lms.cte.model.v103.InfProt) org.exolab.castor.xml.Unmarshaller.unmarshal(com.mercurio.lms.cte.model.v103.InfProt.class, reader);
    }
