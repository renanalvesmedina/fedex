...
import com.mercurio.lms.cte.model.v400.TRetInutCTe;
...
public class TRetInutCTeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public TRetInutCTeDescriptor() {
        ...
        //-- _infInut
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.mercurio.lms.cte.model.v400.InfInut.class, "_infInut", "infInut", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public Object getValue( Object object )
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    TRetInutCTe target = (TRetInutCTe) object;
                    target.setInfInut( (com.mercurio.lms.cte.model.v400.InfInut) value);
                } catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public Object newInstance(Object parent) {
                return new com.mercurio.lms.cte.model.v400.InfInut();
            }
        };
        desc.setSchemaType("com.mercurio.lms.cte.model.v400.InfInut");
        desc.setHandler(handler);
