...
public class Fluxo implements java.io.Serializable {
     ...
     * Field _passList.
     */
    private java.util.List<com.mercurio.lms.cte.model.v104.Pass> _passList;
    ...
    public Fluxo() {
        super();
        this._passList = new java.util.ArrayList<com.mercurio.lms.cte.model.v104.Pass>();
    }
     ...
     */
    public void addPass(
            final com.mercurio.lms.cte.model.v104.Pass vPass)
    throws java.lang.IndexOutOfBoundsException {
        this._passList.add(vPass);
    }
     ...
     * collection
     */
    public java.util.Enumeration<? extends com.mercurio.lms.cte.model.v104.Pass> enumeratePass(
    ) {
        return java.util.Collections.enumeration(this._passList);
    }
     ...
     * @throws java.lang.IndexOutOfBoundsException if the index
     * given is outside the bounds of the collection
     * @return the value of the com.mercurio.lms.cte.model.Pass at
     * the given index
     */
    public com.mercurio.lms.cte.model.v104.Pass getPass(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.mercurio.lms.cte.model.v104.Pass) _passList.get(index);
    }
    ...
    public com.mercurio.lms.cte.model.v104.Pass[] getPass(
        ...
        com.mercurio.lms.cte.model.v104.Pass[] array = new com.mercurio.lms.cte.model.v104.Pass[0];
        return (com.mercurio.lms.cte.model.v104.Pass[]) this._passList.toArray(array);
    }
     ...
     * collection
     */
    public java.util.Iterator<? extends com.mercurio.lms.cte.model.v104.Pass> iteratePass(
    ) {
        return this._passList.iterator();
    }
     ...
     */
    public com.mercurio.lms.cte.model.v104.Pass removePassAt(
            final int index) {
        java.lang.Object obj = this._passList.remove(index);
        return (com.mercurio.lms.cte.model.v104.Pass) obj;
    }
     ...
     */
    public void setPass(
            final com.mercurio.lms.cte.model.v104.Pass[] vPassArray) {
        //-- copy array
        _passList.clear();
     ...
     * following description: Codigo da Rota de Entrega
     * 
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled com.mercurio.lms.cte.model.Fluxo
     */
    public static com.mercurio.lms.cte.model.v104.Fluxo unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.mercurio.lms.cte.model.v104.Fluxo) org.exolab.castor.xml.Unmarshaller.unmarshal(com.mercurio.lms.cte.model.v104.Fluxo.class, reader);
    }
