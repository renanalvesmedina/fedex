...
public enum TCodUfIBGE {
     ...
     * Field enumConstants.
     */
    private static final java.util.Map<String, TCodUfIBGE> enumConstants = new java.util.HashMap<String, TCodUfIBGE>();
    ...
    private TCodUfIBGE(final String value) {
        this.value = value;
    }
     ...
     */
    public static TCodUfIBGE fromValue(
            final String value) {
