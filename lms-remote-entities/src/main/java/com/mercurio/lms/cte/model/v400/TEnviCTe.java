...
public class TEnviCTe implements java.io.Serializable {
     ...
     * Field _CTeList.
     */
    private java.util.Vector<CTe> _CTeList;
    ...
    public TEnviCTe() {
        super();
        this._CTeList = new java.util.Vector<CTe>();
    }
     ...
     * com.mercurio.lms.cte.model.v400.CTe elements
     */
    public java.util.Enumeration<? extends CTe> enumerateCTe(
    ) {
     ...
     * @throws IndexOutOfBoundsException if the index
     * given is outside the bounds of the collection
     * @return the value of the com.mercurio.lms.cte.model.v400.CTe
     * at the given index
     */
    public CTe getCTe(
            final int index)
    ...
    public CTe[] getCTe(
        ...
        CTe[] array = new CTe[0];
        return (CTe[]) this._CTeList.toArray(array);
    }
     ...
     */
    public CTe removeCTeAt(
            final int index) {
        Object obj = this._CTeList.remove(index);
        return (CTe) obj;
    }
     ...
     * com.mercurio.lms.cte.model.v400.TEnviCTe
     */
    public static TEnviCTe unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (TEnviCTe) org.exolab.castor.xml.Unmarshaller.unmarshal(TEnviCTe.class, reader);
    }
