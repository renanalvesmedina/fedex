...
public enum TDocAssoc {
     ...
     * Field enumConstants.
     */
    private static final java.util.Map<String, TDocAssoc> enumConstants = new java.util.HashMap<String, TDocAssoc>();
    ...
    private TDocAssoc(final String value) {
        this.value = value;
    }
     ...
     */
    public static TDocAssoc fromValue(
            final String value) {
