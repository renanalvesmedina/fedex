...
/**
 * Dados do Resultado do Pedido de Cancelamento do Conhecimento de
...
public class InfCanc implements java.io.Serializable {
    ...
    /**
     * Chaves de acesso do CT-e, compostas por: UF do emitente,
     * AAMM da emissão do CT-e, CNPJ do emitente, modelo, série e
    ...
    /**
     * Número do Protocolo de homologação do cancelamento: 1
     * posição tipo de autorizador (1 – Secretaria de Fazenda
     * Estadual 2 – Receita Federal - SCAN, 3 - SEFAZ Virtual RFB
     ...
     * the following description: Chaves de acesso do CT-e,
     * compostas por: UF do emitente, AAMM da emissão do CT-e,
     * CNPJ do emitente, modelo, série e número do CT-e e código
     * numérico + DV.
     * 
     ...
     * e hora da gravação no Banco em caso de Confirmação.
     * 
     ...
     * the following description: Número do Protocolo de
     * homologação do cancelamento: 1 posição tipo de
     ...
     * processou o pedido de cancelamento
     * 
     ...
     * following description: Chaves de acesso do CT-e, compostas
     * por: UF do emitente, AAMM da emissão do CT-e, CNPJ do
     ...
     * hora da gravação no Banco em caso de Confirmação.
     * 
     ...
     * following description: Número do Protocolo de homologação
     * do cancelamento: 1 posição tipo de autorizador (1 –
     * Secretaria de Fazenda Estadual 2 – Receita Federal - SCAN,
     * 3 - SEFAZ Virtual RFB ); 2 posições ano; 10 seqüencial no
     * ano.
     * 
     ...
     * com.mercurio.lms.cte.model.v103.InfCanc
     */
    public static com.mercurio.lms.cte.model.v103.InfCanc unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.mercurio.lms.cte.model.v103.InfCanc) org.exolab.castor.xml.Unmarshaller.unmarshal(com.mercurio.lms.cte.model.v103.InfCanc.class, reader);
    }
