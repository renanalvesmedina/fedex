...
import com.mercurio.lms.cte.model.v400.ComData;
...
public class ComDataDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ComDataDescriptor() {
        ...
        //-- _dProg
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(String.class, "_dProg", "dProg", org.exolab.castor.xml.NodeType.Element);
        desc.setImmutable(true);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public Object getValue( Object object )
