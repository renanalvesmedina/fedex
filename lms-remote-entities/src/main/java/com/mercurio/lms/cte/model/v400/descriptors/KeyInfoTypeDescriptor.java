...
import com.mercurio.lms.cte.model.v400.KeyInfoType;
...
public class KeyInfoTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public KeyInfoTypeDescriptor() {
        ...
        //-- _x509Data
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.mercurio.lms.cte.model.v400.X509Data.class, "_x509Data", "X509Data", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public Object getValue( Object object )
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    KeyInfoType target = (KeyInfoType) object;
                    target.setX509Data( (com.mercurio.lms.cte.model.v400.X509Data) value);
                } catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public Object newInstance(Object parent) {
                return new com.mercurio.lms.cte.model.v400.X509Data();
            }
        };
        desc.setSchemaType("com.mercurio.lms.cte.model.v400.X509Data");
        desc.setHandler(handler);
