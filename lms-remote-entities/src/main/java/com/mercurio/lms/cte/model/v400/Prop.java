...
public class Prop implements java.io.Serializable {
     ...
     * Field _propChoice.
     */
    private PropChoice _propChoice;
     ...
     * Field _propSequence.
     */
    private PropSequence _propSequence;

    /**
     * Tipo Proprietário
     */
    private com.mercurio.lms.cte.model.v400.types.TpPropType _tpProp;
     ...
     */
    public PropChoice getPropChoice(
    ) {
     ...
     */
    public PropSequence getPropSequence(
    ) {
     ...
     */
    public com.mercurio.lms.cte.model.v400.types.TpPropType getTpProp(
    ) {
        return this._tpProp;
    }
    ...
    public void setPropSequence(
            final PropSequence propSequence) {
    ...
    public void setTpProp(
            final com.mercurio.lms.cte.model.v400.types.TpPropType tpProp) {
        this._tpProp = tpProp;
    }
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled com.mercurio.lms.cte.model.v400.Prop
     */
    public static Prop unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (Prop) org.exolab.castor.xml.Unmarshaller.unmarshal(Prop.class, reader);
    }
