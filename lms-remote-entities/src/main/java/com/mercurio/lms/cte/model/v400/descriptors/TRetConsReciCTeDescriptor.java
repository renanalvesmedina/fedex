...
import com.mercurio.lms.cte.model.v400.TRetConsReciCTe;
...
public class TRetConsReciCTeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public TRetConsReciCTeDescriptor() {
        ...
        desc.setValidator(fieldValidator);
        //-- _protCTeList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.mercurio.lms.cte.model.v400.ProtCTe.class, "_protCTeList", "protCTe", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public Object getValue( Object object )
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    TRetConsReciCTe target = (TRetConsReciCTe) object;
                    target.addProtCTe( (com.mercurio.lms.cte.model.v400.ProtCTe) value);
                } catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public Object newInstance(Object parent) {
                return new com.mercurio.lms.cte.model.v400.ProtCTe();
            }
        };
        desc.setSchemaType("list");
        desc.setComponentType("com.mercurio.lms.cte.model.v400.ProtCTe");
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://www.portalfiscal.inf.br/cte");
