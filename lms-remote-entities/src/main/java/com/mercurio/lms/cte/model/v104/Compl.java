...
public class Compl implements java.io.Serializable {
     ...
     */
    private com.mercurio.lms.cte.model.v104.Fluxo _fluxo;

    /**
     * Informações ref. a previsão de entrega
     */
    private com.mercurio.lms.cte.model.v104.Entrega _entrega;
     ...
     */
    private java.util.List<com.mercurio.lms.cte.model.v104.ObsCont> _obsContList;

    /**
     * Campo de uso livre do contribuinte
     */
    private java.util.List<com.mercurio.lms.cte.model.v104.ObsFisco> _obsFiscoList;
    ...
    public Compl() {
        super();
        this._obsContList = new java.util.ArrayList<com.mercurio.lms.cte.model.v104.ObsCont>();
        this._obsFiscoList = new java.util.ArrayList<com.mercurio.lms.cte.model.v104.ObsFisco>();
    }
    ...
    public void addObsCont(
            final com.mercurio.lms.cte.model.v104.ObsCont vObsCont)
    ...
    public void addObsFisco(
            final com.mercurio.lms.cte.model.v104.ObsFisco vObsFisco)
    throws java.lang.IndexOutOfBoundsException {
        // check for the maximum size
     ...
     * collection
     */
    public java.util.Enumeration<? extends com.mercurio.lms.cte.model.v104.ObsCont> enumerateObsCont(
    ) {
     ...
     * collection
     */
    public java.util.Enumeration<? extends com.mercurio.lms.cte.model.v104.ObsFisco> enumerateObsFisco(
    ) {
     ...
     */
    public com.mercurio.lms.cte.model.v104.Entrega getEntrega(
    ) {
     ...
     */
    public com.mercurio.lms.cte.model.v104.Fluxo getFluxo(
    ) {
        return this._fluxo;
    }
     ...
     * @throws java.lang.IndexOutOfBoundsException if the index
     * given is outside the bounds of the collection
     * @return the value of the com.mercurio.lms.cte.model.ObsCont
     * at the given index
     */
    public com.mercurio.lms.cte.model.v104.ObsCont getObsCont(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.mercurio.lms.cte.model.v104.ObsCont) _obsContList.get(index);
    }
    ...
    public com.mercurio.lms.cte.model.v104.ObsCont[] getObsCont(
        ...
        com.mercurio.lms.cte.model.v104.ObsCont[] array = new com.mercurio.lms.cte.model.v104.ObsCont[0];
        return (com.mercurio.lms.cte.model.v104.ObsCont[]) this._obsContList.toArray(array);
    }
     ...
     * @throws java.lang.IndexOutOfBoundsException if the index
     * given is outside the bounds of the collection
     * @return the value of the com.mercurio.lms.cte.model.ObsFisco
     * at the given index
     */
    public com.mercurio.lms.cte.model.v104.ObsFisco getObsFisco(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        ...
        return (com.mercurio.lms.cte.model.v104.ObsFisco) _obsFiscoList.get(index);
    }
    ...
    public com.mercurio.lms.cte.model.v104.ObsFisco[] getObsFisco(
        ...
        com.mercurio.lms.cte.model.v104.ObsFisco[] array = new com.mercurio.lms.cte.model.v104.ObsFisco[0];
        return (com.mercurio.lms.cte.model.v104.ObsFisco[]) this._obsFiscoList.toArray(array);
    }
     ...
     * collection
     */
    public java.util.Iterator<? extends com.mercurio.lms.cte.model.v104.ObsCont> iterateObsCont(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<? extends com.mercurio.lms.cte.model.v104.ObsFisco> iterateObsFisco(
    ) {
     ...
     */
    public com.mercurio.lms.cte.model.v104.ObsCont removeObsContAt(
            final int index) {
        java.lang.Object obj = this._obsContList.remove(index);
        return (com.mercurio.lms.cte.model.v104.ObsCont) obj;
    }
     ...
     * @return the element removed from the collection
     */
    public com.mercurio.lms.cte.model.v104.ObsFisco removeObsFiscoAt(
            final int index) {
        java.lang.Object obj = this._obsFiscoList.remove(index);
        return (com.mercurio.lms.cte.model.v104.ObsFisco) obj;
    }
    ...
    public void setEntrega(
            final com.mercurio.lms.cte.model.v104.Entrega entrega) {
    ...
    public void setFluxo(
            final com.mercurio.lms.cte.model.v104.Fluxo fluxo) {
        this._fluxo = fluxo;
    }
     ...
     */
    public void setObsCont(
            final com.mercurio.lms.cte.model.v104.ObsCont[] vObsContArray) {
        //-- copy array
        _obsContList.clear();
     ...
     */
    public void setObsFisco(
            final com.mercurio.lms.cte.model.v104.ObsFisco[] vObsFiscoArray) {
        //-- copy array
        _obsFiscoList.clear();
     ...
     * the following description: Caracter�stica adicional do
     * transporte
     * 
     ...
     * has the following description: Caracter�stica adicional do
     * serviço
     * 
     ...
     * following description: Funcion�rio emissor do CTe
     * 
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled com.mercurio.lms.cte.model.Compl
     */
    public static com.mercurio.lms.cte.model.v104.Compl unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.mercurio.lms.cte.model.v104.Compl) org.exolab.castor.xml.Unmarshaller.unmarshal(com.mercurio.lms.cte.model.v104.Compl.class, reader);
    }
