...
public enum TpPerType {
     ...
     * Field enumConstants.
     */
    private static final java.util.Map<String, TpPerType> enumConstants = new java.util.HashMap<String, TpPerType>();
    ...
    private TpPerType(final String value) {
        this.value = value;
    }
     ...
     */
    public static TpPerType fromValue(
            final String value) {
