...
import com.mercurio.lms.cte.model.v400.TRetEnviCTe;
...
public class TRetEnviCTeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public TRetEnviCTeDescriptor() {
        ...
        desc.setValidator(fieldValidator);
        //-- _infRec
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.mercurio.lms.cte.model.v400.InfRec.class, "_infRec", "infRec", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public Object getValue( Object object )
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    TRetEnviCTe target = (TRetEnviCTe) object;
                    target.setInfRec( (com.mercurio.lms.cte.model.v400.InfRec) value);
                } catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public Object newInstance(Object parent) {
                return new com.mercurio.lms.cte.model.v400.InfRec();
            }
        };
        desc.setSchemaType("com.mercurio.lms.cte.model.v400.InfRec");
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://www.portalfiscal.inf.br/cte");
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
