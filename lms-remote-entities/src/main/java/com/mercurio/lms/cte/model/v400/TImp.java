...
public class TImp implements java.io.Serializable {
     ...
     * da UF do emitente
     */
    private ICMSOutraUF _ICMSOutraUF;

    /**
     * Simples Nacional
     */
    private ICMSSN _ICMSSN;
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled com.mercurio.lms.cte.model.v400.TImp
     */
    public static TImp unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (TImp) org.exolab.castor.xml.Unmarshaller.unmarshal(TImp.class, reader);
    }
