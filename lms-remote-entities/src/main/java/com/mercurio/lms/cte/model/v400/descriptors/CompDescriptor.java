...
import com.mercurio.lms.cte.model.v400.Comp;
...
public class CompDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public CompDescriptor() {
        ...
        //-- _vComp
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(String.class, "_vComp", "vComp", org.exolab.castor.xml.NodeType.Element);
        desc.setImmutable(true);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public Object getValue( Object object )
