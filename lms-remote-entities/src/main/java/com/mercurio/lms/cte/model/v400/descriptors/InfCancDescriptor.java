...
import com.mercurio.lms.cte.model.v400.InfCanc;
...
public class InfCancDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public InfCancDescriptor() {
        ...
        desc.setValidator(fieldValidator);
        //-- _xServ
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(String.class, "_xServ", "xServ", org.exolab.castor.xml.NodeType.Element);
        desc.setImmutable(true);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public Object getValue( Object object )
        ...
        desc.setValidator(fieldValidator);
        //-- _xJust
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(String.class, "_xJust", "xJust", org.exolab.castor.xml.NodeType.Element);
        desc.setImmutable(true);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public Object getValue( Object object )
