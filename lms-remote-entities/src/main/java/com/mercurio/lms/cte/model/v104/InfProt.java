...
public class InfProt implements java.io.Serializable {
    ...
    /**
     * Numero do Protocolo de Status do CT-e. 1 posicao tipo de
     * autorizador (1 – Secretaria de Fazenda Estadual, 3 - SEFAZ
     * Virtual RS, 5 - SEFAZ Virtual SP ); 2 posicoes ano; 10
     * sequencial no ano.
     */
     ...
     * the following description: Numero do Protocolo de Status do
     * CT-e. 1 posicaoo tipo de autorizador (1 – Secretaria de
     * Fazenda Estadual, 3 - SEFAZ Virtual RS, 5 - SEFAZ Virtual SP
     * ); 2 posicoes ano; 10 sequencial no ano.
     * 
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled com.mercurio.lms.cte.model.InfProt
     */
    public static com.mercurio.lms.cte.model.v104.InfProt unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.mercurio.lms.cte.model.v104.InfProt) org.exolab.castor.xml.Unmarshaller.unmarshal(com.mercurio.lms.cte.model.v104.InfProt.class, reader);
    }
	...
	public void setTpEmis(com.mercurio.lms.cte.model.v104.types.TpEmisType tpEmis) {
		this._tpEmis = tpEmis;
	}
