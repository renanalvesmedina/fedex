...
public enum TpEmisType {
     ...
     * Field enumConstants.
     */
    private static final java.util.Map<String, TpEmisType> enumConstants = new java.util.HashMap<String, TpEmisType>();
    ...
    private TpEmisType(final String value) {
        this.value = value;
    }
     ...
     */
    public static TpEmisType fromValue(
            final String value) {
