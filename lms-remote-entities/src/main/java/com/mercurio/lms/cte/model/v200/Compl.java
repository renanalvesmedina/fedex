...
public class Compl implements java.io.Serializable {
     ...
     */
    private com.mercurio.lms.cte.model.v200.Fluxo _fluxo;

    /**
     * Informações ref. a previsão de entrega
     */
    private com.mercurio.lms.cte.model.v200.Entrega _entrega;
     ...
     */
    private java.util.Vector<com.mercurio.lms.cte.model.v200.ObsCont> _obsContList;

    /**
     * Campo de uso livre do contribuinte
     */
    private java.util.Vector<com.mercurio.lms.cte.model.v200.ObsFisco> _obsFiscoList;
    ...
    public Compl() {
        super();
        this._obsContList = new java.util.Vector<com.mercurio.lms.cte.model.v200.ObsCont>();
        this._obsFiscoList = new java.util.Vector<com.mercurio.lms.cte.model.v200.ObsFisco>();
    }
    ...
    public void addObsCont(
            final com.mercurio.lms.cte.model.v200.ObsCont vObsCont)
    ...
    public void addObsFisco(
            final com.mercurio.lms.cte.model.v200.ObsFisco vObsFisco)
    throws java.lang.IndexOutOfBoundsException {
        // check for the maximum size
     ...
     * com.mercurio.lms.cte.model.v200.ObsCont elements
     */
    public java.util.Enumeration<? extends com.mercurio.lms.cte.model.v200.ObsCont> enumerateObsCont(
    ) {
     ...
     * 
     * @return an Enumeration over all
     * com.mercurio.lms.cte.model.v200.ObsFisco elements
     */
    public java.util.Enumeration<? extends com.mercurio.lms.cte.model.v200.ObsFisco> enumerateObsFisco(
    ) {
     ...
     */
    public com.mercurio.lms.cte.model.v200.Entrega getEntrega(
    ) {
     ...
     */
    public com.mercurio.lms.cte.model.v200.Fluxo getFluxo(
    ) {
        return this._fluxo;
    }
     ...
     * com.mercurio.lms.cte.model.v200.ObsCont at the given index
     */
    public com.mercurio.lms.cte.model.v200.ObsCont getObsCont(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.mercurio.lms.cte.model.v200.ObsCont) _obsContList.get(index);
    }
    ...
    public com.mercurio.lms.cte.model.v200.ObsCont[] getObsCont(
        ...
        com.mercurio.lms.cte.model.v200.ObsCont[] array = new com.mercurio.lms.cte.model.v200.ObsCont[0];
        return (com.mercurio.lms.cte.model.v200.ObsCont[]) this._obsContList.toArray(array);
    }
     ...
     * given is outside the bounds of the collection
     * @return the value of the
     * com.mercurio.lms.cte.model.v200.ObsFisco at the given index
     */
    public com.mercurio.lms.cte.model.v200.ObsFisco getObsFisco(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        ...
        return (com.mercurio.lms.cte.model.v200.ObsFisco) _obsFiscoList.get(index);
    }
    ...
    public com.mercurio.lms.cte.model.v200.ObsFisco[] getObsFisco(
        ...
        com.mercurio.lms.cte.model.v200.ObsFisco[] array = new com.mercurio.lms.cte.model.v200.ObsFisco[0];
        return (com.mercurio.lms.cte.model.v200.ObsFisco[]) this._obsFiscoList.toArray(array);
    }
     ...
     */
    public com.mercurio.lms.cte.model.v200.ObsCont removeObsContAt(
            final int index) {
        java.lang.Object obj = this._obsContList.remove(index);
        return (com.mercurio.lms.cte.model.v200.ObsCont) obj;
    }
     ...
     * @return the element removed from the collection
     */
    public com.mercurio.lms.cte.model.v200.ObsFisco removeObsFiscoAt(
            final int index) {
        java.lang.Object obj = this._obsFiscoList.remove(index);
        return (com.mercurio.lms.cte.model.v200.ObsFisco) obj;
    }
    ...
    public void setEntrega(
            final com.mercurio.lms.cte.model.v200.Entrega entrega) {
    ...
    public void setFluxo(
            final com.mercurio.lms.cte.model.v200.Fluxo fluxo) {
        this._fluxo = fluxo;
    }
     ...
     */
    public void setObsCont(
            final com.mercurio.lms.cte.model.v200.ObsCont[] vObsContArray) {
        //-- copy array
        _obsContList.clear();
     ...
     */
    public void setObsFisco(
            final com.mercurio.lms.cte.model.v200.ObsFisco[] vObsFiscoArray) {
        //-- copy array
        _obsFiscoList.clear();
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled com.mercurio.lms.cte.model.v200.Compl
     */
    public static com.mercurio.lms.cte.model.v200.Compl unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.mercurio.lms.cte.model.v200.Compl) org.exolab.castor.xml.Unmarshaller.unmarshal(com.mercurio.lms.cte.model.v200.Compl.class, reader);
    }
