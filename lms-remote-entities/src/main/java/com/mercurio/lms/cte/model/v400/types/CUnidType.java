...
public enum CUnidType {
     ...
     * Field enumConstants.
     */
    private static final java.util.Map<String, CUnidType> enumConstants = new java.util.HashMap<String, CUnidType>();
    ...
    private CUnidType(final String value) {
        this.value = value;
    }
     ...
     */
    public static CUnidType fromValue(
            final String value) {
