...
import com.mercurio.lms.cte.model.v400.TProtCTe;
...
public class TProtCTeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public TProtCTeDescriptor() {
        ...
        //-- _infProt
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.mercurio.lms.cte.model.v400.InfProt.class, "_infProt", "infProt", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public Object getValue( Object object )
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    TProtCTe target = (TProtCTe) object;
                    target.setInfProt( (com.mercurio.lms.cte.model.v400.InfProt) value);
                } catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public Object newInstance(Object parent) {
                return new com.mercurio.lms.cte.model.v400.InfProt();
            }
        };
        desc.setSchemaType("com.mercurio.lms.cte.model.v400.InfProt");
        desc.setHandler(handler);
