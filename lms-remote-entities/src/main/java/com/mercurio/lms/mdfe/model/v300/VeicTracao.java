...
public class VeicTracao implements java.io.Serializable {
     ...
     */
    private java.util.Vector<com.mercurio.lms.mdfe.model.v300.Condutor> condutorList;

    /**
     * Tipo de Rodado
     */
    private com.mercurio.lms.mdfe.model.v300.types.TpRodType tpRod;
    ...
    public VeicTracao() {
        super();
        this.condutorList = new java.util.Vector<com.mercurio.lms.mdfe.model.v300.Condutor>();
    }
     ...
     */
    public void addCondutor(final com.mercurio.lms.mdfe.model.v300.Condutor vCondutor) throws java.lang.IndexOutOfBoundsException {
     ...
     * given is outside the bounds of the collection
     */
    public void addCondutor(final int index,final com.mercurio.lms.mdfe.model.v300.Condutor vCondutor) throws java.lang.IndexOutOfBoundsException {
        // check for the maximum size
        if (this.condutorList.size() >= 10) {
            throw new IndexOutOfBoundsException("addCondutor has a maximum of 10");
        }
     ...
     * com.mercurio.lms.mdfe.model.v300.Condutor elements
     */
    public java.util.Enumeration<? extends com.mercurio.lms.mdfe.model.v300.Condutor> enumerateCondutor() {
     ...
     * com.mercurio.lms.mdfe.model.v300.Condutor at the given index
     */
    public com.mercurio.lms.mdfe.model.v300.Condutor getCondutor(final int index) throws java.lang.IndexOutOfBoundsException {
     ...
     */
    public com.mercurio.lms.mdfe.model.v300.Condutor[] getCondutor() {
        com.mercurio.lms.mdfe.model.v300.Condutor[] array = new com.mercurio.lms.mdfe.model.v300.Condutor[0];
     ...
     */
    public com.mercurio.lms.mdfe.model.v300.types.TpRodType getTpRod() {
        return this.tpRod;
    }
     ...
     */
    public boolean removeCondutor(final com.mercurio.lms.mdfe.model.v300.Condutor vCondutor) {
     ...
     */
    public com.mercurio.lms.mdfe.model.v300.Condutor removeCondutorAt(final int index) {
        java.lang.Object obj = this.condutorList.remove(index);
        return (com.mercurio.lms.mdfe.model.v300.Condutor) obj;
    }
     ...
     * given is outside the bounds of the collection
     */
    public void setCondutor(final int index,final com.mercurio.lms.mdfe.model.v300.Condutor vCondutor) throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        if (index < 0 || index >= this.condutorList.size()) {
     ...
     */
    public void setCondutor(final com.mercurio.lms.mdfe.model.v300.Condutor[] vCondutorArray) {
        //-- copy array
        condutorList.clear();
     ...
     */
    public void setTpRod(final com.mercurio.lms.mdfe.model.v300.types.TpRodType tpRod) {
        this.tpRod = tpRod;
    }
     ...
     * com.mercurio.lms.mdfe.model.v300.VeicTracao
     */
    public static com.mercurio.lms.mdfe.model.v300.VeicTracao unmarshal(final java.io.Reader reader) throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.mercurio.lms.mdfe.model.v300.VeicTracao) org.exolab.castor.xml.Unmarshaller.unmarshal(com.mercurio.lms.mdfe.model.v300.VeicTracao.class, reader);
    }
