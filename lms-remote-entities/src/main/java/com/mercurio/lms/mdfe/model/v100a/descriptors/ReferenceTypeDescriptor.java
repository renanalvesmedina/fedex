...
import com.mercurio.lms.mdfe.model.v100a.ReferenceType;
...
public class ReferenceTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ReferenceTypeDescriptor() {
        ...
        //-- transforms
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.mercurio.lms.mdfe.model.v100a.Transforms.class, "transforms", "Transforms", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ReferenceType target = (ReferenceType) object;
                    target.setTransforms( (com.mercurio.lms.mdfe.model.v100a.Transforms) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new com.mercurio.lms.mdfe.model.v100a.Transforms();
            }
        };
        desc.setSchemaType("com.mercurio.lms.mdfe.model.v100a.Transforms");
        desc.setHandler(handler);
        ...
        //-- validation code for: transforms
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
        //-- digestMethod
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.mercurio.lms.mdfe.model.v100a.DigestMethod.class, "digestMethod", "DigestMethod", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ReferenceType target = (ReferenceType) object;
                    target.setDigestMethod( (com.mercurio.lms.mdfe.model.v100a.DigestMethod) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new com.mercurio.lms.mdfe.model.v100a.DigestMethod();
            }
        };
        desc.setSchemaType("com.mercurio.lms.mdfe.model.v100a.DigestMethod");
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://www.w3.org/2000/09/xmldsig#");
        desc.setRequired(true);
        desc.setMultivalued(false);
        ...
        //-- validation code for: digestMethod
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
        //-- digestValue
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(byte[].class, "digestValue", "DigestValue", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
        ...
        //-- validation code for: digestValue
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
        }
    ...
    public java.lang.Class getJavaClass() {
        return com.mercurio.lms.mdfe.model.v100a.ReferenceType.class;
    }
