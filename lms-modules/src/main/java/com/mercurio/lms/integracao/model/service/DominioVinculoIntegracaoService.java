 ...
 * @spring.bean id="lms.integracao.dominioVinculoIntegracaoService"
 */
public class DominioVinculoIntegracaoService extends CrudService<DominioVinculoIntegracao, Long> {
	...
	public DominioVinculoIntegracao findById(java.lang.Long id) {
		return (DominioVinculoIntegracao) super.findById(id);
	}
	 ...
	 */
	public java.io.Serializable store(DominioVinculoIntegracao bean) {
     ...
     */
    public void setDominioVinculoIntegracaoDAO(DominioVinculoIntegracaoDAO dao) {
        setDao( dao );
    }
     ...
     */
    private DominioVinculoIntegracaoDAO getDominioVinculoIntegracaoDAO() {
        return (DominioVinculoIntegracaoDAO) getDao();
    }
}