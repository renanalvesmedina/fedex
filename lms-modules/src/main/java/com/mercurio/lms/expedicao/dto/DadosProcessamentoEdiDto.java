...
public class DadosProcessamentoEdiDto implements Serializable {
        ...
        private Boolean isDanfeSimplificada;
        ...
        public Boolean getDanfeSimplificada() {
                return isDanfeSimplificada;
        }

        public void setDanfeSimplificada(Boolean danfeSimplificada) {
                this.isDanfeSimplificada = danfeSimplificada;
        }
}
