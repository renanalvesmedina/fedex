...
public class EmitirTabelaFreteAereaPDF extends TemplatePdf{
	...
	public EmitirTabelaFreteAereaPDF(List<Map<String, String>> cabecalho,
			Map<String, String> dados, List<Map<String, String>> listaPrecos,
			List<Map<String, String>> generalidades,
			List<Map<String, String>> formalidade,
			List<Map<String, String>> servicosAdicionais,
			List<Map<String, String>> dificuldadeEntrega,
			List<Map<String, String>> legendas,
			List<Map<String, String>> aereo,
			List<Map<String, String>> taxaCombustivel,
			Set taxaCombustivelCabecalho, List<Map<String, String>> coleta,
			List<Map<String, String>> entrega,
			List<Map<String, String>> legendaGeneralidades,
			List<Map<String, String>> taxaTerrestre){
		this.listaPrecos = listaPrecos;
		this.listaGeneralidades = generalidades;
		this.listaFormalidades = formalidade;
		this.servicosAdicionais = servicosAdicionais;
		this.dificuldadeEntrega = dificuldadeEntrega;
		this.legendas = legendas;
		this.cabecalho = cabecalho;
		...
		this.entrega = entrega;
		this.legendaGeneralidades = legendaGeneralidades;
		this.terrestre = taxaTerrestre;
		this.dados = dados;
		setUsuario(null);
		
		try {
			File file = File.createTempFile("report-lista-preco-aereo-c" + System.currentTimeMillis(), ".pdf", new ReportExecutionManager().generateOutputDir());
			getDocument(file,true,this.getClass());
			} catch (IOException e) {
				log.error(e);
			}
