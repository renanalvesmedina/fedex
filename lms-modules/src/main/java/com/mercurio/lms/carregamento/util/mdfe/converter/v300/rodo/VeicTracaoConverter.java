...
import com.mercurio.lms.mdfe.model.v300.VeicTracao;
...
public class VeicTracaoConverter {
    ...
    public VeicTracao convert() {
        ...
        //UF
        veicTracao.setUF(MdfeConverterUtils.get300UF((mdfe.getControleCarga().getMeioTransporteByIdTransportado())));
