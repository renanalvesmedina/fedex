...
public class CargoComissaoSuggestDTO extends BaseDTO {
	...
	public CargoComissaoSuggestDTO() {
		super();
	}

	public CargoComissaoSuggestDTO(Long idCliente) {
		this();
		setId(idCliente);
	}

	public CargoComissaoSuggestDTO(Long idCliente, String nmPessoa, String nrIdentificacao) {
		this(idCliente);
		this.nmPessoa = nmPessoa;
		this.nrIdentificacao = nrIdentificacao;
	}

	public CargoComissaoSuggestDTO(Long idCliente, String nmPessoa, String tpCliente, String sgUnidadeFederativa, Long nrConta,
