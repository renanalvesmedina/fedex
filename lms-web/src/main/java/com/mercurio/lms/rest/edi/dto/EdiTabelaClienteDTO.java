...
public class EdiTabelaClienteDTO implements Serializable {
    ...
    public EdiTabelaClienteDTO() {
    }

    public EdiTabelaClienteDTO(Long idEdiTabelaCliente, Long idEdiTabelaOcoren, Long idCliente, String nrIdentificacao, String nomePessoa) {
