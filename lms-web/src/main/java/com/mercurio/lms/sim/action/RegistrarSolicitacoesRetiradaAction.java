 ...
 * @spring.bean id="lms.sim.registrarSolicitacoesRetiradaAction"
 */
...
public class RegistrarSolicitacoesRetiradaAction extends MasterDetailAction {
	...
	public List findLookupNotaFiscal(TypedFlatMap map){
		if(map.getLong("remetente.idCliente")== null)
			throw new BusinessException("LMS-09111");
		return notaFiscalConhecimentoService.findLookupNotaFiscalCliente(map);
	}
	...
	public List findLookupCliente(Map criteria){
		...
		if (!result.isEmpty()){
			...
			item.put("pessoa.nrIdentificacaoFormatado", FormatUtils.formatIdentificacao(cliente.getPessoa().getTpIdentificacao(), cliente.getPessoa().getNrIdentificacao()));
			item.put("pessoa.nmPessoa", cliente.getPessoa().getNmPessoa());
	...
	public ResultSetPage findPaginatedCustom(TypedFlatMap criteria) {	
		...
		ResultSetPage rsp = this.getService().findPaginated(criteria);
		...
		FilterResultSetPage frsp = new FilterResultSetPage(rsp) {
			...
			public Map filterItem(Object item) {
				...
				filterItem.put("idSolicitacaoRetirada", mapItem.get("idSolicitacaoRetirada"));
				filterItem.put("nrSolicitacaoRetirada", mapItem.get("nrSolicitacaoRetirada"));
				filterItem.put("tpRegistroLiberacao", mapItem.get("tpRegistroLiberacao"));
				filterItem.put("tpSituacao", (DomainValue)mapItem.get("tpSituacao"));
				filterItem.put("sgFilial", mapItem.get("sgFilial"));
				
				filterItem.put("nmRemetente", mapItem.get("nmRemetente"));
				filterItem.put("tpIdentificacaoRemetente", mapItem.get("tpIdentificacaoRemetente"));
				filterItem.put("nrIdentificacaoRemetente", FormatUtils.formatIdentificacao((DomainValue)mapItem.get("tpIdentificacaoRemetente"), (String)mapItem.get("nrIdentificacaoRemetente")));
				
				filterItem.put("nmDestinatario", mapItem.get("nmDestinatario"));
				filterItem.put("tpIdentificacaoDestinatario", mapItem.get("tpIdentificacaoDestinatario"));
				filterItem.put("nrIdentificacaoDestinatario", FormatUtils.formatIdentificacao((DomainValue)mapItem.get("tpIdentificacaoDestinatario"), (String)mapItem.get("nrIdentificacaoDestinatario")));
								
				filterItem.put("idFilialRetirada", mapItem.get("idFilialRetirada"));
				filterItem.put("sgFilialRetirada", mapItem.get("sgFilialRetirada"));
				filterItem.put("nmFantasiaRetirada", mapItem.get("nmFantasiaRetirada"));
				filterItem.put("nmResponsavelAutorizacao", mapItem.get("nmResponsavelAutorizacao"));
				filterItem.put("nrMatricula", mapItem.get("nrMatricula"));
				filterItem.put("nmFuncionario", mapItem.get("nmFuncionario"));
				filterItem.put("dsFuncaoResponsavelAutoriza", mapItem.get("dsFuncaoResponsavelAutoriza"));
				filterItem.put("nrTelefoneAutorizador", mapItem.get("nrTelefoneAutorizador"));
				filterItem.put("nmRetirante", mapItem.get("nmRetirante"));
				filterItem.put("tpIdentificacao", mapItem.get("tpIdentificacao"));
				
				if (mapItem.get("tpIdentificacao") != null && mapItem.get("nrCnpj") != null) {
					filterItem.put("nrCnpj", FormatUtils.formatIdentificacao((DomainValue)mapItem.get("tpIdentificacao"), ((Long)mapItem.get("nrCnpj")).toString()));
				}
				
				filterItem.put("nrRg", mapItem.get("nrRg"));
				filterItem.put("dhPrevistaRetirada", mapItem.get("dhPrevistaRetirada"));
				filterItem.put("dhSolicitacao", mapItem.get("dhSolicitacao"));
				filterItem.put("nrManifestoEntrega", mapItem.get("nrManifestoEntrega"));
				filterItem.put("sgFilialManifesto", mapItem.get("sgFilialManifesto"));				
				filterItem.put("dhEmissao", mapItem.get("dhEmissao"));
				filterItem.put("dhFechamento", mapItem.get("dhFechamento"));
	...
	public Map findDadosSessao() {
		...
		retorno.put("sgFilialSolicitacao", filial.getSgFilial());
		retorno.put("idFilialSolicitacao", filial.getIdFilial());
		retorno.put("nmFantasiaSolicitacao", filial.getPessoa().getNmFantasia());
		return retorno;
	}
