 ...
 * @spring.bean id="lms.expedicao.manterCRTAction"
 */
public class ManterCRTAction extends CrudAction {
	...
	private Short calcularPrazoEntrega(CtoInternacional ctoInternacional){
		...
		Short diasPPE = ctoInternacionalService.executeCalculoNrDiasPrevEntrega(
			idMunicipioOrigem,
			idMunicipioDestino,
			idServico,
			idCliente,
	...
	public List findRemetente(TypedFlatMap criteria){
		return findClienteByNrIdentificacao(criteria.getString("pessoa.nrIdentificacao"));
	}

	public List findDestinatario(TypedFlatMap criteria){
		return findRemetente(criteria);
	}
	
	public List findConsignatario(TypedFlatMap criteria){
		return findRemetente(criteria);
	}
	
	public List findNotificado(TypedFlatMap criteria){
		return findRemetente(criteria);
	}

	public List findClienteByNrIdentificacao(String nrIdentificacao){
		return clienteService.findClienteByNrIdentificacao(nrIdentificacao);
	}

	public List findFilialDestino(TypedFlatMap criteria){
		return findFilial(criteria);
	}
	...
	public List findFilialOrigem(TypedFlatMap criteria){
		return findFilial(criteria);
	}
