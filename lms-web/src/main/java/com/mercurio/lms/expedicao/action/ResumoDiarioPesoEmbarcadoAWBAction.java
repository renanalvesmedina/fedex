...
import com.mercurio.lms.expedicao.report.ResumoDiarioPesoEmbarcadoPorAWBService;
 ...
 * @spring.bean id="lms.expedicao.resumoDiarioPesoEmbarcadoAWBAction"
 */

public class ResumoDiarioPesoEmbarcadoAWBAction extends ReportActionSupport {

	private ResumoDiarioPesoEmbarcadoPorAWBService resumoDiarioPesoEmbarcadoPorAWBService;
	
	private FilialService filialService;
	
	@Override
	public java.io.File execute(TypedFlatMap parameters) throws Exception {
		reportServiceSupport = resumoDiarioPesoEmbarcadoPorAWBService;
	...
	public ResumoDiarioPesoEmbarcadoPorAWBService getResumoDiarioPesoEmbarcadoPorAWBService() {
		return resumoDiarioPesoEmbarcadoPorAWBService;
	}

	public void setResumoDiarioPesoEmbarcadoPorAWBService(
			ResumoDiarioPesoEmbarcadoPorAWBService resumoDiarioPesoEmbarcadoPorAWBService) {
		this.resumoDiarioPesoEmbarcadoPorAWBService = resumoDiarioPesoEmbarcadoPorAWBService;
	}
