 ...
 * @spring.bean id="lms.carregamento.cancelarEmissaoControleCargasAction"
 */

public class CancelarEmissaoControleCargasAction {
    ...
    public void generateCancelamentoEmissaoControleCarga(TypedFlatMap tfm) {
    	controleCargaService.generateCancelamentoEmissaoControleCarga(tfm.getLong("idControleCarga"));
    }
}