 ...
 * @spring.bean id="lms.carregamento.dadosDescargaAction"
 */

public class DadosDescargaAction {
    ...
    public TypedFlatMap findDadosDescarga(TypedFlatMap map) {
    	Long idControleCarga = map.getLong("idControleCarga");
    	Long idFilial = map.getLong("idFilial");
    	TypedFlatMap mapRetorno = carregamentoDescargaService.findCarregamentoDescargaByControleCarga(idControleCarga, idFilial, "D");
    	return mapRetorno;
    }
