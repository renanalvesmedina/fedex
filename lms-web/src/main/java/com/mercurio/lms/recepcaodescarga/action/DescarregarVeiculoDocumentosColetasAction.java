 ...
 * este serviço.
 * 
 * @spring.bean id="lms.recepcaodescarga.descarregarVeiculoDocumentosColetasAction"
 */
public class DescarregarVeiculoDocumentosColetasAction extends CrudAction {
	...
	public Integer getRowCount(TypedFlatMap criteria) {
		...
		return getDetalheColetaService().getRowCountDetalheColetaByIdManifestoColeta(idManifestoColeta);
	}	
	...
	public ResultSetPage findPaginated(TypedFlatMap criteria) {		
		...
		ResultSetPage resultSetPage = getDetalheColetaService().findPaginatedDetalheColetaByIdManifestoColeta(idManifestoColeta, findDefinition);
