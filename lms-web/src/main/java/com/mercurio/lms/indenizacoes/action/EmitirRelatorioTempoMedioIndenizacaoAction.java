...
import com.mercurio.lms.indenizacoes.report.EmitirTempoMedioIndenizacaoDetalhadoService;
import com.mercurio.lms.indenizacoes.report.EmitirTempoMedioIndenizacaoResumidoService;
 ...
 * @spring.bean id="lms.indenizacoes.emitirRelatorioTempoMedioIndenizacaoAction"
 */

public class EmitirRelatorioTempoMedioIndenizacaoAction extends ReportActionSupport {
	...
	private EmitirTempoMedioIndenizacaoDetalhadoService emitirTempoMedioIndenizacaoDetalhadoService;
	private EmitirTempoMedioIndenizacaoResumidoService emitirTempoMedioIndenizacaoResumidoService; 

	
	private EmitirTempoMedioIndenizacaoDetalhadoService getEmitirTempoMedioIndenizacaoDetalhadoService() {
		return emitirTempoMedioIndenizacaoDetalhadoService;
	}

	public void setEmitirTempoMedioIndenizacaoDetalhadoService(EmitirTempoMedioIndenizacaoDetalhadoService emitirTempoMedioIndenizacaoDetalhadoService) {
		this.emitirTempoMedioIndenizacaoDetalhadoService = emitirTempoMedioIndenizacaoDetalhadoService;
	}

	private EmitirTempoMedioIndenizacaoResumidoService getEmitirTempoMedioIndenizacaoResumidoService() {
		return emitirTempoMedioIndenizacaoResumidoService;
	}

	public void setEmitirTempoMedioIndenizacaoResumidoService(EmitirTempoMedioIndenizacaoResumidoService emitirTempoMedioIndenizacaoResumidoService) {
		this.emitirTempoMedioIndenizacaoResumidoService = emitirTempoMedioIndenizacaoResumidoService;
	}
    ...
    public java.io.File executeRelatorioResumido(TypedFlatMap parameters) throws Exception {
    	this.reportServiceSupport = getEmitirTempoMedioIndenizacaoResumidoService(); 
    ...
    public java.io.File executeRelatorioDetalhado(TypedFlatMap parameters) throws Exception {
    	this.reportServiceSupport = getEmitirTempoMedioIndenizacaoDetalhadoService(); 
    	return this.reportServiceSupport.executeReport(parameters); 
    }    
}
