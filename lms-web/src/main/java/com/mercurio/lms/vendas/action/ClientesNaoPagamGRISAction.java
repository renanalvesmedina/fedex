...
import com.mercurio.lms.vendas.report.ClienteNaoPagaGRISService;
 ...
 * @spring.bean id="lms.vendas.clientesNaoPagamGRISAction"
 */

public class ClientesNaoPagamGRISAction extends ReportActionSupport {
	...
	public void setClienteNaoPagaGRISService(ClienteNaoPagaGRISService clienteNaoPagaGRISService) {
		this.reportServiceSupport = clienteNaoPagaGRISService;
	}
