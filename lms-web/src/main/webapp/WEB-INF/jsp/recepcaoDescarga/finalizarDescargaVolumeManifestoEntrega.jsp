...
<adsm:window service="lms.recepcaodescarga.finalizarDescargaAction">
	<adsm:form idProperty="idManifestoEntregaVolume" action="/recepcaoDescarga/finalizarDescarga"
			   service="lms.recepcaodescarga.finalizarDescargaAction.findByIdManifestoEntregaVolume">
		...
		<adsm:buttonBar freeLayout="true">
			<adsm:storeButton caption="salvar" service="lms.recepcaodescarga.finalizarDescargaAction.saveManifestoEntregaVolume"/>
			<adsm:resetButton caption="limpar"/>
		</adsm:buttonBar>
	</adsm:form>
	
	<adsm:grid idProperty="idManifestoEntregaVolume" property="manifestoEntregaVolume" selectionMode="check" 
			   gridHeight="200" unique="true" autoSearch="false" detailFrameName="volumes"
   			   service="lms.recepcaodescarga.finalizarDescargaAction.findPaginatedManifestoEntregaVolume" 
			   rowCountService="lms.recepcaodescarga.finalizarDescargaAction.getRowCountManifestoEntregaVolume" >	
		...
		<adsm:buttonBar>
			<adsm:removeButton caption="excluir" 
							   service="lms.recepcaodescarga.finalizarDescargaAction.removeByIdsManifestoEntregaVolume"/>		
		</adsm:buttonBar>
	</adsm:grid>
