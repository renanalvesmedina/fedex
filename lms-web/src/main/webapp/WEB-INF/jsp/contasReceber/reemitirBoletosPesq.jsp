...
<adsm:window>
	...
	<adsm:form action="/contasReceber/reemitirBoletos">
	
		<adsm:hidden property="reemissao" serializable="true" value="true"/>	

	 	<adsm:hidden property="nrIdentificacao" serializable="true"/>
		<adsm:lookup label="cliente"
					 service="lms.contasreceber.reemitirBoletosAction.findLookupCliente" 
					 dataType="text"
					 property="cliente" 
		...
		<!-- Em boleto a situacao da fatura -->
		<adsm:hidden property="tpSituacaoFatura" value="BL"/> 
		
		
		<adsm:lookup label="fatura"
					 action="/municipios/manterFiliais" 
					 service="lms.contasreceber.reemitirBoletosAction.findLookupFilial" 
					 dataType="text" 
			...
			<adsm:lookup serializable="true"
   					 	 service="lms.contasreceber.reemitirBoletosAction.findFaturaByFilialCliente" 
   					 	 dataType="integer" 
	   					 property="fatura" 
   	 					 idProperty="idFatura"
  				...
  				<adsm:propertyMapping criteriaProperty="tpSituacaoFatura" modelProperty="tpSituacaoFatura"/> 
		...
		<adsm:buttonBar>
			<adsm:button caption="visualizar" id="btnRel" disabled="false" onclick="visualizar(this)" buttonType="reportButton"/>
...
<script>
	...
	/**  Controla o focus caso a fatura nao seja preenchida */
	function visualizar(elem){
		var r = reportButtonScript('lms.contasreceber.reemitirBoletosAction', 'openPdf', elem.form);
		
		if ( getElementValue("cliente.idCliente") != null && getElementValue("fatura.idFatura")  == "" ){
