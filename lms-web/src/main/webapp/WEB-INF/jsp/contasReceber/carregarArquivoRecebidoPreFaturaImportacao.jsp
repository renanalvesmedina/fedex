...
<adsm:window onPageLoadCallBack="myOnPageLoad">
	...
	<adsm:form action="/contasReceber/carregarArquivoRecebidoPreFatura">
		<adsm:hidden property="tpSituacao" value="A"/>
		<adsm:hidden property="isDHL" value="true"/>
        ...
        <adsm:textbox labelWidth="15%" width="35%" dataType="JTDate" label="dataEmissao" property="dtEmissao" size="8" maxLength="20" required="true" onchange="calculaVencimento();"/>
	
		<adsm:textbox labelWidth="15%" dataType="JTDate" label="dataVencimento" property="dtVencimento" size="8" maxLength="20" required="true"/>

        <adsm:checkbox property="gerarBoleto" label="gerarBoleto" labelWidth="15%"/>
	
		<adsm:textbox labelWidth="15%" label="arquivo" property="arquivo" dataType="file" width="85%" size="72" required="true"/>
		...
		<adsm:buttonBar>
			...
			<adsm:button 
					...
					id="btnImportar"
					disabled="false"
					onclick="storeButtonScript('lms.contasreceber.carregarArquivoRecebidoPreFaturaAction.executeImportacao', 'retornoImportacao', this.form);"
			/>
			<adsm:button id="btnLimpar" caption="limpar" onclick="cleanButtonScript(this.document);ajustaFoco();" disabled="false"/>
