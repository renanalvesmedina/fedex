...
<script type="text/javascript">
	...
	function loadDataObjects() {	 
		...
		var sdo = createServiceDataObject("lms.carregamento.carregarVeiculoTrocarAction.newMaster", "loadDataObjects");
	...
	function loadDataObjects_cb(data, error){
		...
		if (getElementValue("idCarregamentoDescarga")!="") {
			...
			var sdo = createServiceDataObject("lms.carregamento.carregarVeiculoTrocarAction.findUltimaEquipe", "loadGridData", {idCarregamentoDescarga:idCarregamentoDescargaValue});
	    	xmit({serviceDataObjects:[sdo]});
	    }
	}
...
<adsm:window title="carregarVeiculo" service="lms.carregamento.carregarVeiculoTrocarAction" onPageLoad="loadDataObjects">
	<adsm:form action="/carregamento/carregarVeiculo" idProperty="idEquipeOperacao" id="equipeForm">
		...
		<adsm:lookup property="equipe" dataType="text" idProperty="idEquipe" criteriaProperty="dsEquipe"
					 ...
					 label="equipe" width="85%" maxLength="50" size="50" required="true" minLengthForAutoPopUpSearch="3" exactMatch="false" disabled="true">
	...
	<adsm:grid property="equipeOperacao" idProperty="idEquipeOperacao" 
		service="lms.carregamento.carregarVeiculoTrocarAction.findPaginatedTrocarEquipe"
		rowCountService="lms.carregamento.carregarVeiculoTrocarAction.getRowCountTrocarEquipe"
...
<script javascript>
	...
	function trocarEquipe(){
		...
		var sdo = createServiceDataObject("lms.carregamento.carregarVeiculoTrocarAction.findDataTerminoEquipe", "trocarEquipe", {idCarregamentoDescarga:idCarregamentoDescargaValue});
	    xmit({serviceDataObjects:[sdo]});
	}
	...
	function trocarEquipe_cb(data, error) {	
		...
		var sdo = createServiceDataObject("lms.carregamento.carregarVeiculoTrocarAction.findUltimaEquipe", "loadGridTrocarEquipe", {idCarregamentoDescarga:idCarregamentoDescargaValue});
    	xmit({serviceDataObjects:[sdo]});
	}
	...
	function salvarEquipe(){
		...
		var sdo = createServiceDataObject("lms.carregamento.carregarVeiculoTrocarAction.storeTrocarEquipe", "salvarEquipe", formData);
	    xmit({serviceDataObjects:[sdo]});
	}
	...
	function removeIntegrantes(idEquipe){
		...
		if (abaCarregamento.getElementById("idEquipe").value!=idEquipe){
			var sdo = createServiceDataObject("lms.carregamento.carregarVeiculoTrocarAction.newMaster");
			xmit({serviceDataObjects:[sdo]});
		}	
	}
	...
	function equipeOperacaoOnRowClick(idEquipeOperacao) {
		...
		var data = new Object();
		var sdo = createServiceDataObject("lms.carregamento.carregarVeiculoTrocarAction.newMaster", "equipeOperacaoOnRowClick", data);
		xmit({serviceDataObjects:[sdo]});
