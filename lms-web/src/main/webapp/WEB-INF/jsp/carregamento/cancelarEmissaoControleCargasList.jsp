...
<adsm:window service="lms.carregamento.cancelarEmissaoControleCargasAction" onPageLoad="carregaPagina" onPageLoadCallBack="retornoCarregarPagina" >
	<adsm:form action="/carregamento/cancelarEmissaoControleCargas">

		<adsm:lookup dataType="text" label="controleCargas"
					 property="controleCarga.filialByIdFilialOrigem"
				 	 idProperty="idFilial" criteriaProperty="sgFilial" 
					 service="lms.carregamento.cancelarEmissaoControleCargasAction.findLookupFilialByControleCarga" 
	 		...
	 		<adsm:lookup dataType="integer" property="controleCarga" 
						 ...
						 service="lms.carregamento.cancelarEmissaoControleCargasAction.findLookupControleCarga" 
		...
		<adsm:buttonBar freeLayout="false">
			<adsm:button caption="cancelarEmissaoControleCargas" id="botaoCancelar" disabled="false" 
...
function cancelar_onClick(form) {
    ...
    var sdo = createServiceDataObject("lms.carregamento.cancelarEmissaoControleCargasAction.generateCancelamentoEmissaoControleCarga", "cancelar", 
...
function findDataControleCarga(idControleCarga) {
	var sdo = createServiceDataObject("lms.carregamento.cancelarEmissaoControleCargasAction.findDataControleCarga", "resultado_findDataControleCarga", 
