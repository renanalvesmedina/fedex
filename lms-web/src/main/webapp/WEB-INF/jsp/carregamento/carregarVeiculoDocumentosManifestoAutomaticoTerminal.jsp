...
<adsm:window title="adicionarDocumentosPreManifesto" service="lms.carregamento.carregarVeiculoDocumentosManifestoAction">
	...
	<adsm:grid idProperty="idDoctoServico" property="terminal" gridHeight="162"
			   ...
			   service="lms.carregamento.carregarVeiculoDocumentosManifestoAction.findListTerminal"
		...
		<adsm:gridColumn title="remetente" property="clienteByIdClienteRemetente.pessoa.nmPessoa" width="180" />
		<adsm:gridColumn title="destinatario" property="clienteByIdClienteDestinatario.pessoa.nmPessoa" width="180" />				   
...
<script type="text/javascript">
	 ...
	 */
	function povoaGridTabClick() {		
	   	var formPrincipal = buildFormBeanFromForm(window.parent.document.forms[0]);
	   	formPrincipal.doctoServico.tpDocumentoServico = "";
	...
	function adicionarDocumento() {
		...
		addServiceDataObject(createServiceDataObject("lms.carregamento.carregarVeiculoDocumentosManifestoAction.savePreManifestoDocumento", "adicionarDocumento", data)); 
	...
	function calculaTotais_cb(data, error) {
		var sdo = createServiceDataObject("lms.carregamento.carregarVeiculoDocumentosManifestoAction.getCalculaTotais", "resultadoCalculaTotais", {list:data});
	...
	function myOnSelectAll(checked) {		
		...
		if( checked == true) {
			...
			var sdo = createServiceDataObject("lms.carregamento.carregarVeiculoDocumentosManifestoAction.getValidacaoDoctoServicoSelectAll", "resultadoValidacaoDoctoServicoSelectAll", mapGrid);
		   	xmit({serviceDataObjects:[sdo]});			
		}
	}
	...
	function myOnSelectRow(rowRef) {
		if(rowRef.firstChild.firstChild.checked) {
			...
			var sdo = createServiceDataObject("lms.carregamento.carregarVeiculoDocumentosManifestoAction.getValidacaoDoctoServico", "resultadoValidacaoDoctoServico", mapGrid);
	    	xmit({serviceDataObjects:[sdo]});		
		}
	}
