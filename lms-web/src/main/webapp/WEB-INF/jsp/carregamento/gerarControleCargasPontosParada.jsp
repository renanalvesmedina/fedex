...
<adsm:window service="lms.carregamento.gerarControleCargasAction" >
	...
	<adsm:grid property="pontos" idProperty="id" 
		   selectionMode="none" showPagging="false" scrollBars="vertical" gridHeight="330"
		   service="lms.carregamento.gerarControleCargasAction.findPaginatedPontosParada"
		   rowCountService=""
		   onRowClick="pontos_OnClick" autoSearch="false"
		   >
