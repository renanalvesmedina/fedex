...
<adsm:window title="conteudoControleCargasManifestosTitulo" service="lms.carregamento.manterControleCargasJanelasAction" 
			 onPageLoadCallBack="retornoCarregaPagina" >

	<adsm:form action="/carregamento/manterControleCargasDocumentos">
	...
	<adsm:grid idProperty="idManifesto" property="manifestos" selectionMode="none" 
			   ...
			   service="lms.carregamento.manterControleCargasJanelasAction.findPaginatedManifestos"
			   rowCountService=""
	...
	>
		...
		<adsm:gridColumn title="documentosServico" 	property="documentos" image="/images/popup.gif" openPopup="true" link="javascript:exibirDocumentos" align="center" width="120" />
		<adsm:buttonBar>
...
function povoaDadosMaster() {
	...
	var sdo = createServiceDataObject("lms.carregamento.manterControleCargasJanelasAction.findDadosControleCargaByManifesto", 
...
function exibirDocumentos(id){
	...
	if (tpOperacao == "V" || tpOperacao == "E")
		showModalDialog('carregamento/manterControleCargasDocumentosServico.do?cmd=main&idManifesto=' + id ,window,'unardorned:no;scroll:no;resizable:no;status:no;center=yes;help:no;dialogWidth:790px;dialogHeight:522px;');
	else
	if (tpOperacao == "C") {
