...
<adsm:window title="motivoParadaTitulo" service="lms.carregamento.consultarControleCargasJanelasAction" onPageLoad="carregaPagina" >

	<adsm:form action="/carregamento/consultarControleCargasLocalTroca" >
...
<script>
function povoaForm() {
	var sdo = createServiceDataObject("lms.carregamento.consultarControleCargasJanelasAction.findDescricaoLocalTroca", "retornoDescricaoLocalTroca", 
