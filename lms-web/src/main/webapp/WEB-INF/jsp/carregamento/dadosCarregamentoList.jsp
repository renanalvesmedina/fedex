...
<adsm:window service="lms.carregamento.dadosCarregamentoAction" onPageLoad="carregaPagina" >
	<adsm:form action="/carregamento/dadosCarregamento">
		...
		<adsm:textbox property="dhInicioOperacao" label="inicioCarregamento" dataType="JTDateTimeZone" 
					  labelWidth="18%" width="22%" picker="false" disabled="true"/>
		<adsm:textbox property="dhFimOperacao" label="fimCarregamento" dataType="JTDateTimeZone" 
...
function buscarDados() {
	setDisabled('botaoFechar', false); 
	var sdo = createServiceDataObject("lms.carregamento.dadosCarregamentoAction.findDadosCarregamento", "resultado_buscarDados", 
