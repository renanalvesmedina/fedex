...
<adsm:window service="lms.carregamento.carregarVeiculoTrocarAction">
	<adsm:form idProperty="idIntegranteEqOperac" action="/carregamento/carregarVeiculo" height="150" 
	service="lms.carregamento.carregarVeiculoTrocarAction.findByIdIntegranteEqOperac" onDataLoadCallBack="enableFields">
		...
		<adsm:combobox property="cargoOperacional.idCargoOperacional" optionLabelProperty="dsCargo" optionProperty="idCargoOperacional"
			service="lms.carregamento.carregarVeiculoTrocarAction.findCargos" onlyActiveValues="true"
		...
		<adsm:lookup dataType="text" property="empresa" idProperty="idEmpresa" criteriaProperty="pessoa.nmPessoa"
			service="lms.carregamento.carregarVeiculoTrocarAction.findEmpresas" action="/municipios/manterEmpresas" 
		...
		<adsm:buttonBar freeLayout="true">
			<adsm:storeButton caption="salvarIntegrante" id="salvarIntegranteButton" service="lms.carregamento.carregarVeiculoTrocarAction.saveIntegranteEqOperac" />
	...
	<adsm:grid property="integranteEqOperac" idProperty="idIntegranteEqOperac" gridHeight="170" unique="true" rows="7" 
			   service="lms.carregamento.carregarVeiculoTrocarAction.findPaginatedIntegranteEqOperac" 
			   rowCountService="lms.carregamento.carregarVeiculoTrocarAction.getRowCountIntegranteEqOperac"
		...
		<adsm:buttonBar>
			<adsm:removeButton id="excluirButton" caption="excluirIntegrante" service="lms.carregamento.carregarVeiculoTrocarAction.removeByIdsIntegranteEquipe"/>
		</adsm:buttonBar>
	</adsm:grid>
</adsm:window>
