...
<adsm:window>
	<adsm:form action="/carregamento/dadosDescarga" idProperty="idFotoCarregmtoDescarga" onDataLoadCallBack="retorno_carregaDados"
			   service="lms.carregamento.dadosDescargaAction.findByIdFotoCarregmtoDescarga" >
	...
	<adsm:grid property="fotosCarregamentoDescarga" idProperty="idFotoCarregmtoDescarga" selectionMode="none"
			   ...
			   service="lms.carregamento.dadosDescargaAction.findPaginatedFotos"
			   rowCountService="lms.carregamento.dadosDescargaAction.getRowCountFotos" >
