...
<adsm:window service="lms.carregamento.iniciarCarregamentoAction">
	<adsm:form idProperty="idIntegranteEqOperac" action="/carregamento/iniciarCarregamento" height="150" 
	service="lms.carregamento.iniciarCarregamentoAction.findByIdIntegranteEqOperac" onDataLoadCallBack="enableFields">
		...
		<adsm:combobox property="tpIntegrante" domain="DM_INTEGRANTE_EQUIPE" renderOptions="true"
					   onchange="comboTpIntegranteOnChange(this.value)"
		...
		<adsm:lookup dataType="integer" property="usuario" idProperty="idUsuario" criteriaProperty="nrMatricula" 
			...
			<adsm:propertyMapping criteriaProperty="nmPessoa" modelProperty="filial.pessoa.nmFantasia"/>
		...
		<adsm:lookup property="pessoa" dataType="text" idProperty="idPessoa" 
			...
			service="lms.carregamento.iniciarCarregamentoAction.findLookupPessoa" action="/configuracoes/manterPessoas" 
		...
		<adsm:combobox property="cargoOperacional.idCargoOperacional" optionLabelProperty="dsCargo" optionProperty="idCargoOperacional"
			service="lms.carregamento.iniciarCarregamentoAction.findCargos" onlyActiveValues="true"
		...
		<adsm:lookup dataType="text" property="empresa" idProperty="idEmpresa" criteriaProperty="pessoa.nmPessoa"
			service="lms.carregamento.iniciarCarregamentoAction.findEmpresas" action="/municipios/manterEmpresas" 
		...
		<adsm:buttonBar freeLayout="true">
			<adsm:storeButton caption="salvarIntegrante" id="salvarIntegranteButton" service="lms.carregamento.iniciarCarregamentoAction.saveIntegranteEqOperac" />
			<adsm:button caption="limpar" id="novoIntegranteButton" onclick="novoIntegranteForm();"/>
		</adsm:buttonBar>
	</adsm:form>
	<adsm:grid property="integranteEqOperac" idProperty="idIntegranteEqOperac" gridHeight="170" rows="7" 
			   service="lms.carregamento.iniciarCarregamentoAction.findPaginatedIntegranteEqOperac" 
			   rowCountService="lms.carregamento.iniciarCarregamentoAction.getRowCountIntegranteEqOperac"
			   detailFrameName="integrantes" autoSearch="false">
		...
		<adsm:buttonBar>
			<adsm:removeButton id="excluirButton" caption="excluirIntegrante" service="lms.carregamento.iniciarCarregamentoAction.removeByIdsIntegranteEquipe"/>
		</adsm:buttonBar>
	</adsm:grid>
</adsm:window> 
