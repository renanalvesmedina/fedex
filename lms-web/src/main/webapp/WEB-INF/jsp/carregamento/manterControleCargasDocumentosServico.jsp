...
<adsm:window title="documentos" service="lms.carregamento.manterControleCargasJanelasAction" onPageLoad="carregaPagina" 
			 onPageLoadCallBack="retornoCarregaPagina" >

	<adsm:form action="/carregamento/manterControleCargasDocumentosServico">
		...
		<adsm:combobox property="doctoServico.tpDocumentoServico"
					   ...
					   service="lms.carregamento.manterControleCargasJanelasAction.findTipoDocumentoServico"
					   ...
					   onchange="return changeDocumentWidgetType({
						   ...
						   actionService:'lms.carregamento.manterControleCargasJanelasAction'
					   });"> 
	...
	<adsm:grid idProperty="id" property="documentos" selectionMode="none" 
			   unique="true" autoSearch="false" scrollBars="horizontal" gridHeight="252" rows="12"
			   service="lms.carregamento.manterControleCargasJanelasAction.findPaginatedDocumentos"
			   rowCountService="lms.carregamento.manterControleCargasJanelasAction.getRowCountDocumentos"
	...
	>
		...
		<adsm:gridColumn title="servico" 			property="sgServico" width="80" />
...
function povoaDadosMaster() {
	...
	var sdo = createServiceDataObject("lms.carregamento.manterControleCargasJanelasAction.findDadosManifesto", 
