...
<script type="text/javascript">
	...
	function loadDataObjects() {	
	    onPageLoad(); 
        var data = new Array();	
		var sdo = createServiceDataObject("lms.expedicao.emitirConhecimentosRodoviariosNacionaisAWBAction.getBasicData", "dataSession", data);
    	xmit({serviceDataObjects:[sdo]});
	}
	
</script>
<adsm:window onPageLoad="loadDataObjects">
	<adsm:form action="/expedicao/emitirConhecimentosRodoviariosNacionaisAWB">

		<adsm:hidden property="tpEmp" value="M" serializable="false" />
		<adsm:lookup dataType="text" 
        		property="filial" idProperty="idFilial" criteriaProperty="sgFilial"  
				service="lms.expedicao.emitirConhecimentosRodoviariosNacionaisAWBAction.montaLookupFilial"
		...
		<adsm:buttonBar>
			<adsm:reportViewerButton service="lms.expedicao.emitirConhecimentosRodoviariosNacionaisAWBAction"/>
			<adsm:resetButton/>
		</adsm:buttonBar>
	</adsm:form>
</adsm:window>
