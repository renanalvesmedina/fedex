...
<adsm:window>
	<adsm:form action="/pendencia/manterArmazenagemMercadorias" height="180">
		...
		<adsm:combobox label="documentoServico" property="tipoDocumento" optionLabelProperty="" optionProperty="" service="" prototypeValue="CTRC|CRT|MDA" disabled="false" labelWidth="20%" width="35%">
		...
		<adsm:combobox label="valor" labelWidth="20%" width="80%" required="true" property="moeda" optionLabelProperty="" optionProperty="" service="">
