...
<script type="text/javascript">
	function carregaPagina() {
		...
		// Busca a data atual.
		var sdo = createServiceDataObject("lms.pendencia.abrirMDASelecionarEnderecoAction.getDataAtual", "dataAtual");
...
<adsm:window service="lms.pendencia.abrirMDASelecionarEnderecoAction" onPageLoad="carregaPagina" >
	...
	<adsm:grid idProperty="idEnderecoPessoa" property="enderecoPessoa" 
			   selectionMode="none" rows="15" gridHeight="301" defaultOrder="dsEndereco:asc"
			   unique="true" scrollBars="horizontal" autoSearch="false" >
		<adsm:gridColumn title="tipoLogradouro" property="tipoLogradouro.dsTipoLogradouro" width="130" />
		<adsm:gridColumn title="endereco" property="dsEndereco" width="250" />
		<adsm:gridColumn title="numero" property="nrEndereco" width="60" align="right" />
		...
		<adsm:buttonBar>
			<adsm:button caption="novoEndereco" disabled="false" onclick="showModalDialog('pendencia/abrirMDA.do?cmd=cadastrarEndereco',window,'unardorned:no;scroll:no;resizable:no;status:no;center=yes;help:no;dialogWidth:790px;dialogHeight:250px;');" />
