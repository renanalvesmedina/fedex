...
<adsm:window service="lms.configuracoes.consultarTelefoneEnderecoLogAction" onPageLoad="myPageLoad">
	<adsm:form action="/configuracoes/consultarTelefoneEnderecoLog" >
	...
	<adsm:grid 
			property="gridLog"
			idProperty="idTelefoneEnderecoLog"
			selectionMode="none"
			width="10000"
			scrollBars="horizontal"
  	>
		<adsm:gridColumn property="tpUso" title="tpUso" isDomain="true"/>
		<adsm:gridColumn property="nrDdd" title="nrDdd"/>
		<adsm:gridColumn property="nrTelefone" title="nrTelefone"/>
		<adsm:gridColumn property="nrDdi" title="nrDdi"/>
