...
<adsm:window service="lms.configuracoes.consultarEnderecoPessoaLogAction" onPageLoad="myPageLoad">
	<adsm:form action="/configuracoes/consultarEnderecoPessoaLog" >
	...
	<adsm:grid 
			property="gridLog"
			idProperty="idEnderecoPessoaLog"
			selectionMode="none"
			width="10000"
