...
<adsm:window title="manterReajustesEspecificos">
	...
	<adsm:grid paramId="id" paramProperty="id" showCheckbox="true" unique="true" rows="9" >
		<adsm:gridColumn width="20%" title="empresa" property="empresa" />
		<adsm:gridColumn width="14%" title="regional" property="regional" />
		<adsm:gridColumn width="9%" title="filial" property="filial" />
		<adsm:gridColumn width="12%" title="tipoRota" property="tipoRota" />
		<adsm:gridColumn width="14%" title="rota" property="rota" />
		<adsm:gridColumn width="17%" title="meioTransporte" property="meioTransporte" />
		<adsm:gridColumn width="14%" title="reajuste" property="reajuste" align="right" />		
		<adsm:buttonBar>
