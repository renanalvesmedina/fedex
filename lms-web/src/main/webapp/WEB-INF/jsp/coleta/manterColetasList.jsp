...
<adsm:window service="lms.coleta.consultarColetasAction" onPageLoad="loadPage" onPageLoadCallBack="loadPage">
	...
	<adsm:form action="/coleta/consultarColetas" height="133">
		...
		<adsm:lookup dataType="text" property="filialByIdFilialResponsavel" idProperty="idFilial" criteriaProperty="sgFilial" 
					 ...
					 label="filial" size="3" maxLength="3" labelWidth="17%" width="83%" disabled="true">
			...
			<adsm:textbox dataType="text" property="filialByIdFilialResponsavel.pessoa.nmFantasia" 
						  size="50" maxLength="50" disabled="true"/>
		</adsm:lookup>
		
		<adsm:textbox dataType="integer" label="numeroColeta" labelWidth="17%" width="83%" 
					  property="nrColeta" size="9" maxLength="8" mask="00000000" 
					  />
		...
		<adsm:label key="espacoBranco" width="17%" style="border:none;"/>
		<adsm:multicheckbox property="blProdutoControlado|blProdutoPerigoso|" 
							texts="|produtoControlado|produtoPerigoso" 
							width="83%" cellStyle="vertical-align:bottom;" />
		...
		<adsm:combobox property="regiaoColetaEntregaFil.idRegiaoColetaEntregaFil" optionLabelProperty="dsRegiaoColetaEntregaFil" optionProperty="idRegiaoColetaEntregaFil" 
					   ...
					   onchange="return onChangeRegiaoColeta()" renderOptions="true"
		...
		<adsm:combobox property="detalheColetas.servico.idServico" optionProperty="idServico" optionLabelProperty="dsServico" 
					   service="lms.coleta.consultarColetasAction.findServico" renderOptions="true" 
		...
		<adsm:lookup property="usuario" label="funcionario" 
                     ...
                     service="lms.coleta.manterColetasAction.findLookupUsuarioFuncionario" 
					 action="/configuracoes/consultarFuncionariosView"
            		 dataType="integer" size="16" maxLength="16" width="83%" labelWidth="17%" exactMatch="true" >
			...
			<adsm:propertyMapping modelProperty="filial.idFilial" criteriaProperty="filialByIdFilialResponsavel.idFilial" />
			<adsm:propertyMapping modelProperty="filial.sgFilial" criteriaProperty="filialByIdFilialResponsavel.sgFilial" />
			<adsm:propertyMapping modelProperty="filial.pessoa.nmFantasia" criteriaProperty="filialByIdFilialResponsavel.pessoa.nmFantasia" />
		...
		<adsm:lookup dataType="text" property="detalheColetas.filial" idProperty="idFilial" criteriaProperty="sgFilial" 
			...
			<adsm:textbox dataType="text" property="detalheColetas.filial.pessoa.nmFantasia" 
						  size="50" maxLength="50" disabled="true"/>
		</adsm:lookup>
	...
	<adsm:grid property="coletas" idProperty="idPedidoColeta" scrollBars="horizontal" rows="7" gridHeight="150"
			   service="lms.coleta.consultarColetasAction.findPaginatedConsultarColetas" selectionMode="none"
			   rowCountService="lms.coleta.consultarColetasAction.getRowCountConsultarColetas" onRowClick="populaForm" >
		...
		<adsm:gridColumn title="preAwbAwb" property="awbs" image="/images/popup.gif" width="100" link="/coleta/consultaAWBColeta.do?cmd=main" popupDimension="235,300" linkIdProperty="idPedidoColeta" align="center"/>
...
<script>
	...
	function fillDataUsuario() {
		if(dataUsuario){
			...
			setElementValue("filialSessao.idFilial", dataUsuario.filial.idFilial);
			setElementValue("filialSessao.sgFilial", dataUsuario.filial.sgFilial);
			setElementValue("filialSessao.pessoa.nmFantasia", dataUsuario.filial.pessoa.nmFantasia);
			
			setElementValue("dhPedidoColetaInicial", setFormat(document.getElementById("dhPedidoColetaInicial"), dataUsuario.dataHoraAtualMenos30Dias));
			setElementValue("dhPedidoColetaFinal", setFormat(document.getElementById("dhPedidoColetaFinal"), dataUsuario.dataHoraAtual));			
		}
	}
	...
	function onChangeLookupRota(){
	    ...
	    if(nrRota!="") {
	        ...
	        setDisabled(document.getElementById("regiaoColetaEntregaFil.idRegiaoColetaEntregaFil"), false);
	        setDisabled(document.getElementById("cliente.idCliente"), false);
	        setFocus(document.getElementById("regiaoColetaEntregaFil.idRegiaoColetaEntregaFil"));
	    }
	    return retorno;
	}
