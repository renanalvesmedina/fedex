...
<adsm:window service="lms.coleta.programacaoColetasVeiculosAction" >
	...
	<adsm:grid property="coletasVeiculosEntregasRealizar" idProperty="idPedidoColeta" 
			   ...
			   service="lms.coleta.programacaoColetasVeiculosAction.findPaginatedColetasVeiculosEntregasRealizar"
			   rowCountService="lms.coleta.programacaoColetasVeiculosAction.getRowCountColetasVeiculosEntregasRealizar"
