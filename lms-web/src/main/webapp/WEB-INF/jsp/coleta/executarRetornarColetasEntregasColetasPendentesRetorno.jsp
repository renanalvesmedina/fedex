...
<adsm:window title="retornoColeta" service="lms.coleta.executarColetasPendentesRetornoAction" onPageLoadCallBack="carregaPagina_retorno">
	<adsm:form action="/coleta/executarColetasPendentesRetorno" idProperty="idPedidoColeta">
		...
		<adsm:combobox property="ocorrenciaColeta.idOcorrenciaColeta" 
					   ...
					   service="lms.coleta.executarColetasPendentesRetornoAction.findOcorrenciaColeta" 
					   label="motivoRetorno" labelWidth="20%" width="80%" required="true" 
		...
		<adsm:combobox property="ocorrenciaColeta.blIneficienciaFrota" label="ineficienciaFrota" domain="DM_SIM_NAO" 
					   labelWidth="20%" width="80%" required="true" renderOptions="true" />
		...
		<adsm:lookup dataType="text" property="meioTransporte" 
					 ...
					 service="lms.coleta.executarColetasPendentesRetornoAction.findLookupMeioTransporte" 
		...
		<adsm:textbox label="registradaPor" property="nmUsuario" dataType="text" labelWidth="10%" width="30%" disabled="true" serializable="false" />
...
function confirmarDataHoraEvento_cb(data, error) {			
	if (data._exception!=undefined) {
		...
		var remoteCall = {serviceDataObjects:new Array()}; 
		remoteCall.serviceDataObjects.push(createServiceDataObject("lms.coleta.executarColetasPendentesRetornoAction.generateRetornarColeta", "resultadoExecutar", data)); 
		xmit(remoteCall);
	}	
}
