...
<adsm:window>
	<adsm:form action="/coleta/emitirRelatorioEstatisticoColetasRotaSintetico">
		...
		<adsm:buttonBar>
			<adsm:reportViewerButton service="coleta/emitirRelatorioEstatisticoColetasRotaSintetico.jasper"/>
