...
<adsm:window>
	<adsm:form action="/municipios/manterRotasIda">
	    <adsm:lookup service="" dataType="integer" width="85%" property="filial.id"  criteriaProperty="filial.codigo" label="rotaIda" size="4" maxLength="2" action="/municipios/manterFiliais">
