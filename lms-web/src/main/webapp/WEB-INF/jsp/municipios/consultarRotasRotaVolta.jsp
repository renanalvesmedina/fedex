...
<adsm:window service="lms.municipios.consultarRotasViagemAction" >
	<adsm:form action="/municipios/consultarRotas" idProperty="idRotaIdaVolta" height="390" onDataLoadCallBack="rotaLoad"
		...
		<adsm:textbox dataType="integer" label="rotaVolta" property="nrRota" disabled="true" mask="0000" size="5" labelWidth="18%" width="32%" >
		...
		<adsm:grid property="trechoRotaIdaVolta" idProperty="idTrechoRotaIdaVolta" showPagging="false" scrollBars="vertical"
			...
			<adsm:gridColumn title="distancia" property="nrDistancia" dataType="integer" unit="km2" width="60" />
...
<script>
	...
	function detalhamentoAba() {
		...
		var sdo = createServiceDataObject("lms.municipios.consultarRotasViagemAction.findByIdRotaVolta",
				"findByIdRotaVolta",data);
		xmit({serviceDataObjects:[sdo]});
	}
	
	function findByIdRotaVolta_cb(data,error) {
		rotaLoad_cb(data,error);
	}
