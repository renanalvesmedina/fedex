...
<adsm:window title="manterTabelasDivisao" type="main" onPageLoad="setAbas">
	<adsm:tabGroup selectedTab="0">
		<adsm:tab title="listagem" id="pesq" src="/vendas/manterTabelasDivisao" cmd="list"/>
		<adsm:tab title="detalhamento" id="cad" src="/vendas/manterTabelasDivisao" cmd="cad"/>
	</adsm:tabGroup>
</adsm:window>
<script>
