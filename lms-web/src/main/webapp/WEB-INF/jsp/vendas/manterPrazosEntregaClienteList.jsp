...
<adsm:window service="lms.municipios.prazoEntregaClienteService" onPageLoadCallBack="myPageLoad">
	<adsm:form action="/vendas/manterPrazosEntregaCliente" height="140">
		...
		<adsm:i18nLabels>
			<adsm:include key="LMS-36075"/>
		</adsm:i18nLabels>

		<adsm:textbox label="cliente" property="cliente.pessoa.nrIdentificacao" dataType="text" size="20" 
			maxLength="20" labelWidth="16%" width="85%" disabled="true" 
			serializable="false">
			<adsm:textbox dataType="text" property="cliente.pessoa.nmPessoa" size="60" 
				maxLength="60" disabled="true" serializable="false"/>
		</adsm:textbox>	
		...
		<adsm:combobox 
			service="lms.vendas.manterParametrosClienteAction.findTipoLocalizacao" 
		...
		<adsm:combobox property="servico.idServico" 
			...
			labelWidth="16%"
			width="37%" boxWidth="250"/>

		<adsm:textbox property="nrPrazo" 
		label="prazoEntrega2" dataType="integer" 
		mask="###0" size="4" 
		maxLength="4" 
		unit="horas"
		width="20%"/>
		...
		<adsm:buttonBar freeLayout="true">
			<adsm:findButton callbackProperty="prazoEntregaCliente"/>
			<adsm:resetButton />
		</adsm:buttonBar>
	</adsm:form>

	<adsm:grid
		selectionMode="check" idProperty="idPrazoEntregaCliente" property="prazoEntregaCliente" 
		width="920" unique="true" scrollBars="horizontal" gridHeight="125" rows="6"
		onSelectAll="validaPermissaoGrid" onSelectRow="validaPermissaoGrid">
		<adsm:gridColumn title="zonaOrigem" property="zonaByIdZonaOrigem.dsZona" width="100"/>
		<adsm:gridColumn title="paisOrigem" property="paisByIdPaisOrigem.nmPais" width="100"/>
		...
		<adsm:gridColumn title="aeroportoOrigem" property="aeroportoByIdAeroportoOrigem.pessoa.nmPessoa" width="200"/>
		...
		<adsm:gridColumn title="zonaDestino" property="zonaByIdZonaDestino.dsZona" width="100"/>
		<adsm:gridColumn title="paisDestino" property="paisByIdPaisDestino.nmPais" width="100"/>
		...
		<adsm:gridColumn title="aeroportoDestino" property="aeroportoByIdAeroportoDestino.pessoa.nmPessoa" width="200"/>
...
<script type="text/javascript">
	...
	/**
	*	Funções referentes as lookups de aeroporto (Origem e Destino)
	*/
	...
	*/
	function myPageLoad_cb(data, error) {
		...
		var sdo = createServiceDataObject("lms.vendas.manterPrazosEntregaClienteAction.validatePermissao", "validarPermissoes", data);
		xmit({serviceDataObjects:[sdo]});
	}
