...
<adsm:window service="lms.vendas.manterClienteOperadorLogisticoAction" onPageLoadCallBack="myPageLoad">
	<adsm:form action="/vendas/manterClienteOperadorLogistico">
		...
		<adsm:buttonBar freeLayout="true">
			<adsm:findButton callbackProperty="clienteOperadorLogistico"/>
			<adsm:resetButton/>
		</adsm:buttonBar>
				
	</adsm:form>
	
	<adsm:grid idProperty="idClienteOperadorLogistico" property="clienteOperadorLogistico" selectionMode="check" unique="true"
			   rows="13"
			   service="lms.vendas.manterClienteOperadorLogisticoAction.findPaginated"
			   rowCountService="lms.vendas.manterClienteOperadorLogisticoAction.getRowCount">
		<adsm:gridColumn title="cliente" property="clienteOperado.pessoa.nmPessoa" width="100%"/>
		<adsm:buttonBar>
