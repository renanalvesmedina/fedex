...
<adsm:window onPageLoad="myOnPageLoad" onPageLoadCallBack="findDadosSessao">
	...
	<adsm:form action="/vendas/emitirRelClientesDescontoTotalFrete">
		...
		<adsm:combobox
			...
			service="lms.vendas.emitirRelClientesDescontoTotalFreteAction.findRegional"
			boxWidth="240">
		...
		<adsm:lookup
			label="filial" labelWidth="15%" width="8%"
			property="filial"
			idProperty="idFilial"
			criteriaProperty="sgFilial"
			action="/municipios/manterFiliais" 
			service="lms.vendas.emitirRelClientesDescontoTotalFreteAction.findLookupFilial"
			dataType="text"
			size="3"
			maxLength="3"
			exactMatch="true"
		...
		<adsm:textbox dataType="JTDate" property="dataReferencia" required="true" label="dataReferencia"/>
		...
		<adsm:buttonBar>
			<!-- vendas/emitirRelClientesDescontoTotalFrete.jasper -->
			<adsm:reportViewerButton service="lms.vendas.emitirRelClientesDescontoTotalFreteAction"/>
			<adsm:resetButton/>
		</adsm:buttonBar>
	</adsm:form>
</adsm:window>
...
function findDadosSessao_cb(data, error) {
	if(error != undefined) {
		...
		var sdo = createServiceDataObject("lms.vendas.emitirRelClientesDescontoTotalFreteAction.findDadosSessao", "ajustaDadosSessao");
