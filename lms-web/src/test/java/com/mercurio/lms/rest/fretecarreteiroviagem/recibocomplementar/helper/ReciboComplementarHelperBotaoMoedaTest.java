 ...
 *
 */
public class ReciboComplementarHelperBotaoMoedaTest  {
		...
		public void isDesabilitaObservacaoFilialGerado() throws Exception {
			...
			Assert.assertTrue(ReciboComplementarRestHelper.isHabilitaTxtMoeda(situacoes));
		}
		...
		public void isDesabilitaObservacaoFilialRejeitado2404() throws Exception {
			...
			Assert.assertFalse(ReciboComplementarRestHelper.isHabilitaTxtMoeda(situacoes));
		}
