 ...
 *
 */
public class ReciboComplementarHelperBotaoObservacaoTest  {
		...
		public void isDesabilitaObservacaoFilialGerado() throws Exception {
			...
			Assert.assertTrue(ReciboComplementarRestHelper.isHabilitaObservacao(situacoes));
		}
		...
		public void isDesabilitaObservacaoFilialRejeitado2404() throws Exception {
			...
			Assert.assertFalse(ReciboComplementarRestHelper.isHabilitaObservacao(situacoes));
		}
