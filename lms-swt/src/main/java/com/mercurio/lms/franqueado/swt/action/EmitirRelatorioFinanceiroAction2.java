...
import com.mercurio.lms.franqueados.report.RelatorioFinanceiroService2;

public class EmitirRelatorioFinanceiroAction2 extends ReportActionSupport {
	...
	public void setEmitirRelatorioFinanceiroService(RelatorioFinanceiroService2 relatorioFinanceiroService2) {
		this.reportServiceSupport = relatorioFinanceiroService2;
	}
