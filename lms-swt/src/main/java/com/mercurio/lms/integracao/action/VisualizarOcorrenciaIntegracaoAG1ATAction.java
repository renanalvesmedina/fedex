 ...
 * @spring.bean id="lms.integracao.swt.visualizarOcorrenciaIntegracaoAG1ATAction"
 */
public class VisualizarOcorrenciaIntegracaoAG1ATAction extends CrudAction {
	...
	public ResultSetPage findPaginated(Map criteria) {
		...
		ResultSetPage rsp = getOcorrenciaIntegracaoService().findPaginatedLayoutList("AG", piTypes.PILMSF26E.toString(), sgFilial, nrFatura, sgFilial2, nrFatura2, findDef);
	...
	public Integer getRowCount(Map criteria) {
		...
		return getOcorrenciaIntegracaoService().getRowCount("AG", piTypes.PILMSF26E.toString(), sgFilial, nrFatura, sgFilial2, nrFatura2);
	}
	...
	public Map findDadosOcorrencia(Map criteria) {
		...
		return getOcorrenciaIntegracaoService().findDadosOcorrenciaById(idOcorrenciaIntegracao, PILMSF26E.AG1AT.toString());
	}
