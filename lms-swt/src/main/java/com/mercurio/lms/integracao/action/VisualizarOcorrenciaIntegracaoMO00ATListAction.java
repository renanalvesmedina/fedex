 ...
 * @spring.bean id="lms.integracao.swt.visualizarOcorrenciaIntegracaoMO00ATListAction"
 */
public class VisualizarOcorrenciaIntegracaoMO00ATListAction extends CrudAction{
	public void store(Map parameters) {
		List<MO00AT> list = (List) parameters.get("layoutList");
		Long idOcorrenciaIntegracao = (Long) parameters.get("idOcorrenciaIntegracao");
		getOcorrenciaIntegracaoService().storeLayoutMO00ATPICo26e(idOcorrenciaIntegracao, list);
	}
