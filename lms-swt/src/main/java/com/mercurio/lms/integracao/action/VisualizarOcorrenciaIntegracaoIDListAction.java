 ...
 * @spring.bean id="lms.integracao.swt.visualizarOcorrenciaIntegracaoIDListAction"
 */
public class VisualizarOcorrenciaIntegracaoIDListAction extends CrudAction {

	public void store(Map parameters) {
		List<ID> list = (List) parameters.get("layoutList");
		Long idOcorrenciaIntegracao = (Long) parameters.get("idOcorrenciaIntegracao");
		getOcorrenciaIntegracaoService().storeLayoutIDPI19e(idOcorrenciaIntegracao, list);
	}
