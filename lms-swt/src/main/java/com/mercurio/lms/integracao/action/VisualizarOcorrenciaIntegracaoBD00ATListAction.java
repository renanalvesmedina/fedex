 ...
 * @spring.bean id="lms.integracao.swt.visualizarOcorrenciaIntegracaoBD00ATListAction"
 */
public class VisualizarOcorrenciaIntegracaoBD00ATListAction extends CrudAction {
	public void store(Map parameters) {
		List<BD00AT> list = (List) parameters.get("layoutList");
		Long idOcorrenciaIntegracao = (Long) parameters.get("idOcorrenciaIntegracao");
		getOcorrenciaIntegracaoService().storeLayoutBd00AtPICo27e(idOcorrenciaIntegracao, list);
	}
