 ...
 * @spring.bean id="lms.integracao.swt.visualizarOcorrenciaIntegracaoJDRPListAction"
 */
public class VisualizarOcorrenciaIntegracaoJDRPListAction extends CrudAction {
	public void store(Map parameters) {
		List<JDRP> list = (List) parameters.get("layoutList");
		Long idOcorrenciaIntegracao = (Long) parameters.get("idOcorrenciaIntegracao");
		getOcorrenciaIntegracaoService().storeLayoutJDRPe(idOcorrenciaIntegracao, list);
	}
