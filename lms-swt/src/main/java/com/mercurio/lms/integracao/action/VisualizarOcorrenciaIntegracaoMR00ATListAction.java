 ...
 * @spring.bean id="lms.integracao.swt.visualizarOcorrenciaIntegracaoMR00ATListAction"
 */
public class VisualizarOcorrenciaIntegracaoMR00ATListAction extends CrudAction {
	public void store(Map parameters) {
		List<MR00AT> list = (List) parameters.get("layoutList");
		Long idOcorrenciaIntegracao = (Long) parameters.get("idOcorrenciaIntegracao");
		getOcorrenciaIntegracaoService().storeLayoutMr00AtPICo27e(idOcorrenciaIntegracao, list);
	}
