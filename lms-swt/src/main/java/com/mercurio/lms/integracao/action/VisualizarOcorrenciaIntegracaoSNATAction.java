 ...
 * @spring.bean id="lms.integracao.swt.visualizarOcorrenciaIntegracaoSNATAction"
 */
public class VisualizarOcorrenciaIntegracaoSNATAction extends CrudAction {
	...
	public ResultSetPage findPaginated(Map criteria) {
		...
		ResultSetPage rsp = getOcorrenciaIntegracaoService().findPaginatedLayoutList("SN", piTypes.PILMSF26E.toString(), sgFilial, nrManifesto, findDef);
	...
	public Integer getRowCount(Map criteria) {
		...
		return getOcorrenciaIntegracaoService().getRowCount("SN", piTypes.PILMSF26E.toString(), sgFilial, nrManifesto);
	}
	...
	public Map findDadosOcorrencia(Map criteria) {
		...
		return getOcorrenciaIntegracaoService().findDadosOcorrenciaById(idOcorrenciaIntegracao, PILMSF26E.SNAT.toString());
	}
