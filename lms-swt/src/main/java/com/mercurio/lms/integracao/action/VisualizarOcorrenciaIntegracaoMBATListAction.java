 ...
 * @spring.bean id="lms.integracao.swt.visualizarOcorrenciaIntegracaoMBATListAction"
 */
public class VisualizarOcorrenciaIntegracaoMBATListAction extends CrudAction {

	public void store(Map parameters) {
		List<MBAT> list = (List) parameters.get("layoutList");
		Long idOcorrenciaIntegracao = (Long) parameters.get("idOcorrenciaIntegracao");
		getOcorrenciaIntegracaoService().storeLayoutMBPI26e(idOcorrenciaIntegracao, list);
	}
