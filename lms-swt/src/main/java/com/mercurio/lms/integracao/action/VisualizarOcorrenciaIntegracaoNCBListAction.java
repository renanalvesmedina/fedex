 ...
 * @spring.bean id="lms.integracao.swt.visualizarOcorrenciaIntegracaoNCBListAction"
 */
public class VisualizarOcorrenciaIntegracaoNCBListAction extends CrudAction {
	public void store(Map parameters) {
		List<NCB> list = (List) parameters.get("layoutList");
		Long idOcorrenciaIntegracao = (Long) parameters.get("idOcorrenciaIntegracao");
		getOcorrenciaIntegracaoService().storeLayoutNCBPI19e(idOcorrenciaIntegracao, list);
	}
