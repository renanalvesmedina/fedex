 ...
 * @spring.bean id="lms.integracao.swt.visualizarOcorrenciaIntegracaoNCBATAction"
 */
public class VisualizarOcorrenciaIntegracaoNCBATAction extends CrudAction {
	public ResultSetPage findPaginated(Map criteria) {
		...
		ResultSetPage rsp = getOcorrenciaIntegracaoService().findPaginatedLayoutList("NCB", piTypes.PILMSF26E.toString(), sgFilial, nrFatura, sgFilial2, nrFatura2, findDef);
	...
	public Integer getRowCount(Map criteria) {
		...
		return getOcorrenciaIntegracaoService().getRowCount("NCB", piTypes.PILMSF26E.toString(), sgFilial, nrFatura, sgFilial2, nrFatura2);
	}
	...
	public Map findDadosOcorrencia(Map criteria) {
		...
		return getOcorrenciaIntegracaoService().findDadosOcorrenciaById(idOcorrenciaIntegracao, PILMSF26E.NCBAT.toString());
	}
