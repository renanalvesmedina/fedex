 ...
 * @spring.bean id="lms.integracao.swt.visualizarOcorrenciaIntegracaoCO01ATListAction"
 */
public class VisualizarOcorrenciaIntegracaoCO01ATListAction extends CrudAction {

	public void store(Map parameters) {
		List<CO01AT> list = (List) parameters.get("layoutList");
		Long idOcorrenciaIntegracao = (Long) parameters.get("idOcorrenciaIntegracao");
		getOcorrenciaIntegracaoService().storeLayoutCO01ATPICo26e(idOcorrenciaIntegracao, list);
	}
