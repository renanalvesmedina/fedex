 ...
 * @spring.bean id="lms.integracao.swt.visualizarOcorrenciaIntegracaoTKATListAction"
 */
public class VisualizarOcorrenciaIntegracaoTKATListAction extends CrudAction {

	public void store(Map parameters) {
		List<TKAT> list = (List) parameters.get("layoutList");
		Long idOcorrenciaIntegracao = (Long) parameters.get("idOcorrenciaIntegracao");
		getOcorrenciaIntegracaoService().storeLayoutTKATPI26e(idOcorrenciaIntegracao, list);
	}
