 ...
 * @spring.bean id="lms.integracao.swt.visualizarOcorrenciaIntegracaoCO01Action"
 */
public class VisualizarOcorrenciaIntegracaoCO01Action extends CrudAction {
	...
	public ResultSetPage findPaginated(Map criteria) {
		...
		ResultSetPage rsp = getOcorrenciaIntegracaoService().findPaginatedLayoutList("CO", piTypes.PILMSC019E.toString(), sgFilial, nrConhecimento, sgFilial2, nrConhecimento2, findDef);
	...
	public Integer getRowCount(Map criteria) {
		...
		return getOcorrenciaIntegracaoService().getRowCount("CO", piTypes.PILMSC019E.toString(), sgFilial, nrConhecimento, sgFilial2, nrConhecimento2);
	}
	...
	public Map findDadosOcorrencia(Map criteria) {
		...
		return getOcorrenciaIntegracaoService().findDadosOcorrenciaById(idOcorrenciaIntegracao, PILMSC019E.CO01.toString());
	}
