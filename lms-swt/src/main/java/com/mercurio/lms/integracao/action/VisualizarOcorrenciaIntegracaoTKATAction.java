 ...
 * @spring.bean id="lms.integracao.swt.visualizarOcorrenciaIntegracaoTKATAction"
 */
public class VisualizarOcorrenciaIntegracaoTKATAction extends CrudAction {
	...
	public ResultSetPage findPaginated(Map criteria) {
		...
		ResultSetPage rsp = getOcorrenciaIntegracaoService().findPaginatedLayoutList("TK", piTypes.PILMSF26E.toString(), sgFilial, nrFatura, sgFilial2, nrConhecimento2, findDef);
	...
	public Integer getRowCount(Map criteria) {
		...
		return getOcorrenciaIntegracaoService().getRowCount("TK", piTypes.PILMSF26E.toString(), sgFilial, nrFatura, sgFilial2, nrConhecimento2);
	}
	...
	public Map findDadosOcorrencia(Map criteria) {
		...
		return getOcorrenciaIntegracaoService().findDadosOcorrenciaById(idOcorrenciaIntegracao, PILMSF26E.TKAT.toString());
	}
