 ...
 * @spring.bean id="lms.integracao.swt.visualizarOcorrenciaIntegracaoCEAAAction"
 */
public class VisualizarOcorrenciaIntegracaoCEAAAction extends CrudAction {
	...
	public ResultSetPage findPaginated(Map criteria) {
		...
		ResultSetPage rsp = ocorrenciaService.findPaginatedLayoutList("CE", piTypes.PILMSC001E.toString(), sgFilial, nrConhecimento, sgFilial2, nrConhecimento2, findDef);
	...
	public Integer getRowCount(Map criteria) {
		...
		return getOcorrenciaIntegracaoService().getRowCount("CE", piTypes.PILMSC001E.toString(), sgFilial, nrConhecimento, sgFilial2, nrConhecimento2);
	}
	...
	public Map findDadosOcorrencia(Map criteria) {
		...
		Map map = getOcorrenciaIntegracaoService().findDadosOcorrenciaById(idOcorrenciaIntegracao, "CEAA");
		return map;
	}
