 ...
 * @spring.bean id="lms.integracao.swt.visualizarOcorrenciaIntegracaoMAListAction"
 */
public class VisualizarOcorrenciaIntegracaoMAListAction extends CrudAction {

	public void store(Map parameters) {
		
		List<MA> list = (List) parameters.get("layoutList");
		Long idOcorrenciaIntegracao = (Long) parameters.get("idOcorrenciaIntegracao");
		getOcorrenciaIntegracaoService().storeLayoutMaPICo19e(idOcorrenciaIntegracao, list);
	}
