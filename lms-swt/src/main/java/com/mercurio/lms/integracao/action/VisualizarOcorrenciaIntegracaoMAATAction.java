 ...
 * @spring.bean id="lms.integracao.swt.visualizarOcorrenciaIntegracaoMAATAction"
 */
public class VisualizarOcorrenciaIntegracaoMAATAction extends CrudAction {
	...
	public ResultSetPage findPaginated(Map criteria) {
		...
		ResultSetPage rsp = getOcorrenciaIntegracaoService().findPaginatedLayoutList("MA", piTypes.PILMSF26E.toString(), sgFilial, nrManifesto, findDef);
	...
	public Integer getRowCount(Map criteria) {
		...
		return getOcorrenciaIntegracaoService().getRowCount("MA", piTypes.PILMSF26E.toString(), sgFilial, nrManifesto);
	}
	...
	public Map findDadosOcorrencia(Map criteria) {
		...
		return getOcorrenciaIntegracaoService().findDadosOcorrenciaById(idOcorrenciaIntegracao, PILMSF26E.MAAT.toString());
	}
