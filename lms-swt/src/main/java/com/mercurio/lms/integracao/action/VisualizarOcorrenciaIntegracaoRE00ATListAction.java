 ...
 * @spring.bean id="lms.integracao.swt.visualizarOcorrenciaIntegracaoRE00ATListAction"
 */
public class VisualizarOcorrenciaIntegracaoRE00ATListAction extends CrudAction {
	
	public void store(Map parameters) {
		List<RE00AT> list = (List) parameters.get("layoutList");
		Long idOcorrenciaIntegracao = (Long) parameters.get("idOcorrenciaIntegracao");
		getOcorrenciaIntegracaoService().storeLayoutRE00AT26e(idOcorrenciaIntegracao, list);
	}
