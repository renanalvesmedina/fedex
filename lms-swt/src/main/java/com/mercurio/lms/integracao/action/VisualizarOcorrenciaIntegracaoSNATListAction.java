 ...
 * @spring.bean id="lms.integracao.swt.visualizarOcorrenciaIntegracaoSNATListAction"
 */
public class VisualizarOcorrenciaIntegracaoSNATListAction extends CrudAction {

	public void store(Map parameters) {
		List<SNAT> list = (List) parameters.get("layoutList");
		Long idOcorrenciaIntegracao = (Long) parameters.get("idOcorrenciaIntegracao");
		getOcorrenciaIntegracaoService().storeLayoutSNPI26e(idOcorrenciaIntegracao, list);
	}
