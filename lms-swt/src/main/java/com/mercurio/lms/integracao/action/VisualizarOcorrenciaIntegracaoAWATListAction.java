 ...
 * @spring.bean id="lms.integracao.swt.visualizarOcorrenciaIntegracaoAWATListAction"
 */
public class VisualizarOcorrenciaIntegracaoAWATListAction extends CrudAction {
	public void store(Map parameters) {
		List<AWAT> list = (List) parameters.get("layoutList");
		Long idOcorrenciaIntegracao = (Long) parameters.get("idOcorrenciaIntegracao");
		getOcorrenciaIntegracaoService().storeLayoutAWATPI26e(idOcorrenciaIntegracao, list);
	}
