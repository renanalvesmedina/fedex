 ...
 * @spring.bean id="lms.integracao.swt.visualizarOcorrenciaIntegracaoCO01ATAction"
 */
public class VisualizarOcorrenciaIntegracaoCO01ATAction extends CrudAction {
	...
	public ResultSetPage findPaginated(Map criteria) {
		...
		ResultSetPage rsp = getOcorrenciaIntegracaoService().findPaginatedLayoutList("CO", piTypes.PILMSF26E.toString(), sgFilial, nrConhecimento, sgFilial2, nrConhecimento2, findDef);
	...
	public Integer getRowCount(Map criteria) {
		...
		return getOcorrenciaIntegracaoService().getRowCount("CO", piTypes.PILMSF26E.toString(), sgFilial, nrConhecimento, sgFilial2, nrConhecimento2);
	}
	...
	public Map findDadosOcorrencia(Map criteria) {
		...
		return getOcorrenciaIntegracaoService().findDadosOcorrenciaById(idOcorrenciaIntegracao, PILMSF26E.CO01AT.toString());
	}
