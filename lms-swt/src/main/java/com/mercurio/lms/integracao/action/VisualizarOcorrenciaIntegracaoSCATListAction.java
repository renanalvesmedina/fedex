 ...
 * @spring.bean id="lms.integracao.swt.visualizarOcorrenciaIntegracaoSCATListAction"
 */
public class VisualizarOcorrenciaIntegracaoSCATListAction  extends CrudAction{
	public void store(Map parameters) {
		
		List<SCAT> list = (List) parameters.get("layoutList");
		Long idOcorrenciaIntegracao = (Long) parameters.get("idOcorrenciaIntegracao");
		getOcorrenciaIntegracaoService().storeLayoutSCATPI26e(idOcorrenciaIntegracao, list);
	}
