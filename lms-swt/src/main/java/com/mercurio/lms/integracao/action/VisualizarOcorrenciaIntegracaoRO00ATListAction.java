 ...
 * @spring.bean id="lms.integracao.swt.visualizarOcorrenciaIntegracaoRO00ATListAction"
 */
public class VisualizarOcorrenciaIntegracaoRO00ATListAction extends CrudAction {

	public void store(Map parameters) {
		List<RO00AT> list = (List) parameters.get("layoutList");
		Long idOcorrenciaIntegracao = (Long) parameters.get("idOcorrenciaIntegracao");
		getOcorrenciaIntegracaoService().storeLayoutRo00AtPICo27e(idOcorrenciaIntegracao, list);
	}
