 ...
 * @spring.bean id="lms.integracao.swt.visualizarOcorrenciaIntegracaoCEATAction"
 */
public class VisualizarOcorrenciaIntegracaoCEATAction extends CrudAction {
	...
	public ResultSetPage findPaginated(Map criteria) {
		...
		ResultSetPage rsp = ocorrenciaService.findPaginatedLayoutList("CE", piTypes.PILMSF26E.toString(), sgFilial, nrConhecimento, sgFilial2, nrConhecimento2, findDef);
	...
	public Integer getRowCount(Map criteria) {
		...
		return getOcorrenciaIntegracaoService().getRowCount("CE", piTypes.PILMSF26E.toString(), sgFilial, nrConhecimento, sgFilial2, nrConhecimento2);
	}
	...
	public Map findDadosOcorrencia(Map criteria) {
		...
		return getOcorrenciaIntegracaoService().findDadosOcorrenciaById(idOcorrenciaIntegracao, PILMSF26E.CEAT.toString());
	}
