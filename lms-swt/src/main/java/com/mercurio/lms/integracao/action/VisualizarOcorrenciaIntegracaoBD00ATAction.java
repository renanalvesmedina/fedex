 ...
 * @spring.bean id="lms.integracao.swt.visualizarOcorrenciaIntegracaoBD00ATAction"
 */
public class VisualizarOcorrenciaIntegracaoBD00ATAction extends CrudAction{
	public ResultSetPage findPaginated(Map criteria) {
		...
		ResultSetPage rsp = getOcorrenciaIntegracaoService().findPaginatedLayoutList("BD00", piTypes.PILMSF27E.toString(), sgFilial, nrDocumento, findDef);
	...
	public Integer getRowCount(Map criteria) {
		...
		return getOcorrenciaIntegracaoService().getRowCount("BD00", piTypes.PILMSF27E.toString(), sgFilial, nrDocumento);
	}
	...
	public Map findDadosOcorrencia(Map criteria) {
		...
		return getOcorrenciaIntegracaoService().findDadosOcorrenciaById(idOcorrenciaIntegracao, PILMSF27E.BD00AT.toString());
	}
