 ...
 * @spring.bean id="lms.integracao.swt.visualizarOcorrenciaIntegracaoCEATListAction"
 */
public class VisualizarOcorrenciaIntegracaoCEATListAction extends CrudAction {
	public void store(Map parameters) {
		List<CEAT> list = (List) parameters.get("layoutList");
		Long idOcorrenciaIntegracao = (Long) parameters.get("idOcorrenciaIntegracao");
		getOcorrenciaIntegracaoService().storeLayoutCEATPI26e(idOcorrenciaIntegracao, list);
	}
