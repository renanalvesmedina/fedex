...
import com.mercurio.lms.integracao.model.service.OcorrenciaIntegracaoService.PILMSJ006E;
 ...
 * @spring.bean id="lms.integracao.swt.visualizarOcorrenciaIntegracaoJDRPAction"
 */
public class VisualizarOcorrenciaIntegracaoJDRPAction extends CrudAction {
	
	public ResultSetPage findPaginated(Map criteria) {
		String nrDocumento = (String) criteria.get("nrDocumento");
		nrDocumento = nrDocumento != null ? nrDocumento.toUpperCase() : null;
				
		FindDefinition findDef = FindDefinition.createFindDefinition(criteria);
		ResultSetPage rsp = getOcorrenciaIntegracaoService().findPaginatedLayoutList("JDRP", piTypes.PILMSJ006E.toString(), nrDocumento, null, findDef);
	...
	public Integer getRowCount(Map criteria) {
		...
		return getOcorrenciaIntegracaoService().getRowCount("JDRP", piTypes.PILMSJ006E.toString(), nrDocumento, null);
	}
	...
	public Map findDadosOcorrencia(Map criteria) {
		...
		return getOcorrenciaIntegracaoService().findDadosOcorrenciaById(idOcorrenciaIntegracao, PILMSJ006E.JDRP.toString());
	}
