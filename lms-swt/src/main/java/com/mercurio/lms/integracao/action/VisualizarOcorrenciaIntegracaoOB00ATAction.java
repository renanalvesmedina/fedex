 ...
 * @spring.bean id="lms.integracao.swt.visualizarOcorrenciaIntegracaoOB00ATAction"
 */
public class VisualizarOcorrenciaIntegracaoOB00ATAction extends CrudAction {
	public ResultSetPage findPaginated(Map criteria) {
		...
		if(nrDocumento != null)
			nrDocumento = nrDocumento.substring(0, nrDocumento.length()-1);
		
		FindDefinition findDef = FindDefinition.createFindDefinition(criteria);
		ResultSetPage rsp = getOcorrenciaIntegracaoService().findPaginatedLayoutListOB("OB00", piTypes.PILMSF27E.toString(), sgFilial, nrDocumento, findDef);
	...
	public Integer getRowCount(Map criteria) {
		...
		return getOcorrenciaIntegracaoService().getRowCountOB("OB00", piTypes.PILMSF27E.toString(), sgFilial, nrDocumento);
	}
	...
	public Map findDadosOcorrencia(Map criteria) {
		...
		return getOcorrenciaIntegracaoService().findDadosOcorrenciaById(idOcorrenciaIntegracao, PILMSF27E.OB00AT.toString());
	}
