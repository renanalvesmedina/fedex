 ...
 * @spring.bean id="lms.integracao.swt.visualizarOcorrenciaIntegracaoRE00ATAction"
 */
public class VisualizarOcorrenciaIntegracaoRE00ATAction extends CrudAction {
	...
	public ResultSetPage findPaginated(Map criteria) {
		...
		ResultSetPage rsp = getOcorrenciaIntegracaoService().findPaginatedLayoutList("RE", piTypes.PILMSF27E.toString(), sgFilial, nrFatura, sgFilial2, nrFatura2, findDef);
	...
	public Integer getRowCount(Map criteria) {
		...
		return getOcorrenciaIntegracaoService().getRowCount("RE", piTypes.PILMSF27E.toString(), sgFilial, nrFatura, sgFilial2, nrFatura2);
	}
	...
	public Map findDadosOcorrencia(Map criteria) {
		...
		return getOcorrenciaIntegracaoService().findDadosOcorrenciaById(idOcorrenciaIntegracao, PILMSF27E.RE00AT.toString());
	}
