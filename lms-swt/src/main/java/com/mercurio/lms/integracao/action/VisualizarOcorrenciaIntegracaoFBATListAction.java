 ...
 * @spring.bean id="lms.integracao.swt.visualizarOcorrenciaIntegracaoFBATListAction"
 */
public class VisualizarOcorrenciaIntegracaoFBATListAction extends CrudAction {
	public void store(Map parameters) {
		List<FBAT> list = (List) parameters.get("layoutList");
		Long idOcorrenciaIntegracao = (Long) parameters.get("idOcorrenciaIntegracao");
		getOcorrenciaIntegracaoService().storeLayoutFbAtPICo27e(idOcorrenciaIntegracao, list);
	}
