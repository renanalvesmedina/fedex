 ...
 * @spring.bean id="lms.integracao.swt.visualizarOcorrenciaIntegracaoOB00ATListAction"
 */
public class VisualizarOcorrenciaIntegracaoOB00ATListAction extends CrudAction {
	public void store(Map parameters) {
		List<OB00AT> list = (List) parameters.get("layoutList");
		Long idOcorrenciaIntegracao = (Long) parameters.get("idOcorrenciaIntegracao");
		getOcorrenciaIntegracaoService().storeLayoutOb00AtPICo27e(idOcorrenciaIntegracao, list);
	}
