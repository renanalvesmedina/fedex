 ...
 * @spring.bean id="lms.integracao.swt.visualizarOcorrenciaIntegracaoMO00ATAction"
 */
public class VisualizarOcorrenciaIntegracaoMO00ATAction extends CrudAction{
	public ResultSetPage findPaginated(Map criteria) {
		...
		ResultSetPage rsp = getOcorrenciaIntegracaoService().findPaginatedLayoutListOB("MO00AT", piTypes.PILMSF26E.toString(), sgFilial, nrCpfCnpj, findDef);
	...
	public Integer getRowCount(Map criteria) {
		...
		return getOcorrenciaIntegracaoService().getRowCountOB("MO00AT", piTypes.PILMSF26E.toString(), sgFilial, nrCpfCnpj);
	}
	...
	public Map findDadosOcorrencia(Map criteria) {
		...
		return getOcorrenciaIntegracaoService().findDadosOcorrenciaById(idOcorrenciaIntegracao, PILMSF26E.MO00AT.toString());
	}
