 ...
 * @spring.bean id="lms.integracao.swt.visualizarOcorrenciaIntegracaoMBATAction"
 */
public class VisualizarOcorrenciaIntegracaoMBATAction extends CrudAction {
	...
	public ResultSetPage findPaginated(Map criteria) {
		...
		ResultSetPage rsp = getOcorrenciaIntegracaoService().findPaginatedLayoutList("MB", piTypes.PILMSF26E.toString(), sgFilial, nrManifesto, findDef);
	...
	public Integer getRowCount(Map criteria) {
		...
		return getOcorrenciaIntegracaoService().getRowCount("MB", piTypes.PILMSF26E.toString(), sgFilial, nrManifesto);
	}
	...
	public Map findDadosOcorrencia(Map criteria) {
		...
		return getOcorrenciaIntegracaoService().findDadosOcorrenciaById(idOcorrenciaIntegracao, PILMSF26E.MBAT.toString());
	}
