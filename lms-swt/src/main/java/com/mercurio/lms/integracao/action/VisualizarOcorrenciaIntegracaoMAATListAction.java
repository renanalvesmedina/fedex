 ...
 * @spring.bean id="lms.integracao.swt.visualizarOcorrenciaIntegracaoMAATListAction"
 */
public class VisualizarOcorrenciaIntegracaoMAATListAction extends CrudAction {

	public void store(Map parameters) {
		List<MAAT> list = (List) parameters.get("layoutList");
		Long idOcorrenciaIntegracao = (Long) parameters.get("idOcorrenciaIntegracao");
		getOcorrenciaIntegracaoService().storeLayoutMaAtPICo26e(idOcorrenciaIntegracao, list);
	}
