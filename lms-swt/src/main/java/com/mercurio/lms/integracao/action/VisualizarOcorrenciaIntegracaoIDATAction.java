 ...
 * @spring.bean id="lms.integracao.swt.visualizarOcorrenciaIntegracaoIDATAction"
 */
public class VisualizarOcorrenciaIntegracaoIDATAction extends CrudAction {
	...
	public ResultSetPage findPaginated(Map criteria) {
		...
		ResultSetPage rsp = getOcorrenciaIntegracaoService().findPaginatedLayoutList("ID", piTypes.PILMSF26E.toString(), sgFilial, nrConhecimento, sgFilial2, nrConhecimento2, findDef);
	...
	public Integer getRowCount(Map criteria) {
		String sgFilial = (String) criteria.get("sgFilial");
		Integer nrConhecimento = (Integer) criteria.get("nrManifesto");
		String sgFilial2 = (String) criteria.get("sgFilial2");		
		Integer nrConhecimento2 = (Integer) criteria.get("nrConhecimento2");
		sgFilial = sgFilial != null ? sgFilial.toUpperCase() : null;
		sgFilial2 = sgFilial2 != null ? sgFilial2.toUpperCase() : null;
		
		return getOcorrenciaIntegracaoService().getRowCount("ID", piTypes.PILMSF26E.toString(), sgFilial, nrConhecimento, sgFilial2, nrConhecimento2);
	}
	...
	public Map findDadosOcorrencia(Map criteria) {
		...
		return getOcorrenciaIntegracaoService().findDadosOcorrenciaById(idOcorrenciaIntegracao, PILMSF26E.IDAT.toString());
	}
